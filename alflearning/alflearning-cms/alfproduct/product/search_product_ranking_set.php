...
<body>
<script type="text/javascript">
function serchSet(rank_i, pid, pname){
	if(!window.opener || window.opener.closed){
		window.close();
	} else{
		if(window.opener.document.getElementById("product_id_" + rank_i)!= null){
			window.opener.document.getElementById("product_id_" + rank_i).value = utf.URLdecode(pid);
		}
		if(window.opener.document.getElementById("product_name_" + rank_i)!= null){
