...
// 一括ダウンロードファイル
if (isset($_FILES["all_contents_download"])){
	if ($_FILES["all_contents_download"]["error"] === 0){
		$file_form_name = "all_contents_download";
		$file_form_name_before = "all_contents_download_before";
	}
}
...
if (is_uploaded_file($_FILES[$file_form_name]['tmp_name'])){
	...
	$upload_dir_name ="/alflearning-data/alfproduct/all_contents";
