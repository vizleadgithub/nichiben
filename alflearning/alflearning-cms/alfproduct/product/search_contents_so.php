...
取得条件は確認する
************/
$sql = "select count(*) as c from video where status=0 and sound_only=1 ";
...
取得条件は確認する
************/
$sql = "select * from video where status=0 and sound_only=1 ";
...
$template->admin_layout('product/search_contents_so.tpl', true);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
?>