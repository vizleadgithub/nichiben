...
if( isset($_GET["search"]) && $_GET["search"]=="new" ){
	...
	if( isset($_SESSION["product_lecture2.search_product_name"]) && !empty($_SESSION["product_lecture2.search_product_name"]) ){
		$search_product_name = $_SESSION["product_lecture2.search_product_name"];
	}
	if( isset($_SESSION["product_lecture2.search_product_code"]) && !empty($_SESSION["product_lecture2.search_product_code"]) ){
		$search_product_code = $_SESSION["product_lecture2.search_product_code"];
	}
	if( isset($_SESSION["product_lecture2.search_start_date"]) && !empty($_SESSION["product_lecture2.search_start_date"]) ){
		$search_start_date = $_SESSION["product_lecture2.search_start_date"];
	}
	if( isset($_SESSION["product_lecture2.search_end_date"]) && !empty($_SESSION["product_lecture2.search_end_date"]) ){
		$search_end_date = $_SESSION["product_lecture2.search_end_date"];
	}
	if( isset($_SESSION["product_lecture2.search_category"]) && !empty($_SESSION["product_lecture2.search_category"]) ){
		$search_category = $_SESSION["product_lecture2.search_category"];
	}
	if( isset($_SESSION["product_lecture2.search_open"]) && !empty($_SESSION["product_lecture2.search_open"]) ){
		$search_open = $_SESSION["product_lecture2.search_open"];
	}
	if( isset($_SESSION["product_lecture2.search_teacher"]) && !empty($_SESSION["product_lecture2.search_teacher"]) ){
		$search_teacher = $_SESSION["product_lecture2.search_teacher"];
	}
	if( isset($_SESSION["product_lecture2.search_free"]) && !empty($_SESSION["product_lecture2.search_free"]) ){
		$search_free = $_SESSION["product_lecture2.search_free"];
	}
	if( isset($_SESSION["product_lecture2.search_word"]) && !empty($_SESSION["product_lecture2.search_word"]) ){
		$search_word = $_SESSION["product_lecture2.search_word"];
	}
	if( isset($_SESSION["product_lecture2.search_bar_association"]) && !empty($_SESSION["product_lecture2.search_bar_association"]) ){
		$search_bar_association = $_SESSION["product_lecture2.search_bar_association"];
	}
	if( isset($_SESSION["product_lecture2.search_bar_association2"]) && !empty($_SESSION["product_lecture2.search_bar_association2"]) ){
		$search_bar_association2 = $_SESSION["product_lecture2.search_bar_association2"];
	}
}
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
	...
	$_SESSION["product_lecture2.search_product_name"] = $search_product_name;
	$_SESSION["product_lecture2.search_product_code"] = $search_product_code;
	$_SESSION["product_lecture2.search_start_date"] = $search_start_date;
	$_SESSION["product_lecture2.search_end_date"] = $search_end_date;
	$_SESSION["product_lecture2.search_category"] = $search_category;
	$_SESSION["product_lecture2.search_open"] = $search_open;
	$_SESSION["product_lecture2.search_teacher"] = $search_teacher;
	$_SESSION["product_lecture2.search_free"] = $search_free;
	$_SESSION["product_lecture2.search_word"] = $search_word;
	$_SESSION["product_lecture2.search_bar_association"] = $search_bar_association;
	$_SESSION["product_lecture2.search_bar_association2"] = $search_bar_association2;

	$_SESSION["product_lecture2.page"] = 1;
	$_GET["page"] = 1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$page = 1;
if( isset($_SESSION["product_lecture2.page"]) && !empty($_SESSION["product_lecture2.page"]) ){
	$page = $_SESSION["product_lecture2.page"];
}
if( isset($_GET["page"]) && !empty($_GET["page"]) && is_numeric($_GET["page"]) ){
	$page = $_GET["page"];
	$_SESSION["product_lecture2.page"] = $page;
}
...
//var_dump( $select_cat );
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$sql = "select TP.product_id,RPBA . *  from ((tbl_product TP LEFT JOIN tbl_product_add TPA ON (TP.product_id = TPA.product_id)) LEFT JOIN tbl_product_live_training TPLT ON (TP.product_id = TPLT.product_id)) LEFT JOIN rel_product_bar_association RPBA ON (TP.product_id = RPBA.product_id) where TP.del_flg=0";

// 会場研修のみ
$where = " and TPA.product_type_add = 2";

// 倫理対象商品絞り
$where .= " and TPLT.ethic_flg=1 ";
...
$template->admin_layout('product_lecture2/index.tpl');
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
?>
