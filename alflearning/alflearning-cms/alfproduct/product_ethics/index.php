...
$search_free = "0";
$search_word = "";
$search_bar_association_year = "";

if( isset($_GET["search"]) && $_GET["search"]=="new" ){
} else {
	if( isset($_SESSION["product_ethics.search_product_name"]) && !empty($_SESSION["product_ethics.search_product_name"]) ){
		$search_product_name = $_SESSION["product_ethics.search_product_name"];
	}
	if( isset($_SESSION["product_ethics.search_product_code"]) && !empty($_SESSION["product_ethics.search_product_code"]) ){
		$search_product_code = $_SESSION["product_ethics.search_product_code"];
	}
	if( isset($_SESSION["product_ethics.search_start_date"]) && !empty($_SESSION["product_ethics.search_start_date"]) ){
		$search_start_date = $_SESSION["product_ethics.search_start_date"];
	}
	if( isset($_SESSION["product_ethics.search_end_date"]) && !empty($_SESSION["product_ethics.search_end_date"]) ){
		$search_end_date = $_SESSION["product_ethics.search_end_date"];
	}
	if( isset($_SESSION["product_ethics.search_category"]) && !empty($_SESSION["product_ethics.search_category"]) ){
		$search_category = $_SESSION["product_ethics.search_category"];
	}
	if( isset($_SESSION["product_ethics.search_open"]) && !empty($_SESSION["product_ethics.search_open"]) ){
		$search_open = $_SESSION["product_ethics.search_open"];
	}
	if( isset($_SESSION["product_ethics.search_teacher"]) && !empty($_SESSION["product_ethics.search_teacher"]) ){
		$search_teacher = $_SESSION["product_ethics.search_teacher"];
	}
	if( isset($_SESSION["product_ethics.search_free"]) && !empty($_SESSION["product_ethics.search_free"]) ){
		$search_free = $_SESSION["product_ethics.search_free"];
	}
	if( isset($_SESSION["product_ethics.search_word"]) && !empty($_SESSION["product_ethics.search_word"]) ){
		$search_word = $_SESSION["product_ethics.search_word"];
	}
	if( isset($_SESSION["product_ethics.search_bar_association_year"]) && !empty($_SESSION["product_ethics.search_bar_association_year"]) ){
		$search_bar_association_year = $_SESSION["product_ethics.search_bar_association_year"];
	}
}
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
	...
	$search_bar_association_year = trim($_POST["search_bar_association_year"]);

	$_SESSION["product_ethics.search_product_name"] = $search_product_name;
	$_SESSION["product_ethics.search_product_code"] = $search_product_code;
	$_SESSION["product_ethics.search_start_date"] = $search_start_date;
	$_SESSION["product_ethics.search_end_date"] = $search_end_date;
	$_SESSION["product_ethics.search_category"] = $search_category;
	$_SESSION["product_ethics.search_open"] = $search_open;
	$_SESSION["product_ethics.search_teacher"] = $search_teacher;
	$_SESSION["product_ethics.search_free"] = $search_free;
	$_SESSION["product_ethics.search_word"] = $search_word;
	$_SESSION["product_ethics.search_bar_association_year"] = $search_bar_association_year;

	$_SESSION["product_ethics.page"] = 1;
	$_GET["page"] = 1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$page = 1;
if( isset($_SESSION["product_ethics.page"]) && !empty($_SESSION["product_ethics.page"]) ){
	$page = $_SESSION["product_ethics.page"];
}
if( isset($_GET["page"]) && !empty($_GET["page"]) && is_numeric($_GET["page"]) ){
	$page = $_GET["page"];
	$_SESSION["product_ethics.page"] = $page;
}
...
$sql = "select count(tbl_product.product_id) as c from tbl_product INNER JOIN tbl_product_add ON tbl_product.product_id = tbl_product_add.product_id INNER JOIN tbl_product_ethic_training ON tbl_product.product_id = tbl_product_ethic_training.product_id where tbl_product.del_flg=0 ";
...
if( $search_bar_association_year != "" ){
	$where.= " and ( tbl_product_ethic_training.bar_association_year = '".mysqli_real_escape_string($objDbConnect->connect,$search_bar_association_year)."' ) ";
}
...
<li class="selected"><a href="./../product_ethics/index.php" style="font-size:13px">倫理代替措置研修*</a></li>
';
...
$template->assign('search_bar_association_year', $search_bar_association_year);
...
$template->admin_layout('product_ethics/index.tpl');
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
?>
