...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$template->assign('ethic_group', get_ethic_group());
...
if(!isset($_POST['act'])){
	$arr_input = array();
	$sql = "select * from tbl_product INNER JOIN tbl_product_add ON tbl_product.product_id = tbl_product_add.product_id INNER JOIN tbl_product_ethic_training ON tbl_product.product_id = tbl_product_ethic_training.product_id where tbl_product.product_id='".$mid."'";
	...
	$template->admin_layout('product_ethics/info.tpl');
