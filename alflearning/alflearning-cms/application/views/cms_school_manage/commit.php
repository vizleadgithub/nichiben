				...
				<?php if( $teacher_id > 0 ): ?>
					<table class="form">
						<tr>
							...
							<td width="400"><?= htmlspecialchars( $school_name, ENT_QUOTES, 'UTF-8', false) ?></td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_teacher_name','講師名') ?></th>
							<td><?= htmlspecialchars( $teacher_name, ENT_QUOTES, 'UTF-8', false) ?></td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_mail_address','メールアドレス') ?></th>
							<td><?= htmlspecialchars( $teacher_email, ENT_QUOTES, 'UTF-8', false) ?></td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_password','パスワード') ?></th>
							<td><?= htmlspecialchars( $teacher_password, ENT_QUOTES, 'UTF-8', false) ?></td>
						</tr>
					</table>
				<?php endif ?>
