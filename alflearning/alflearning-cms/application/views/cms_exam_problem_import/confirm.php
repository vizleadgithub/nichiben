...
<?php
	...
	<script type="text/javascript">
		...
		$(function () {
			setTimeout(function(){
				$.ajax({
					url: "/cms_exam_problem_import/commit",
					type: "POST",
					...
					success: function(response) {
						if(response){
							...
							$("#h2_title").text("<?= $this->lang->line_or_def('msg_exam_problem_import_commit','設問へのインポート結果') ?>");
	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<div id="contents_main">
				...
				<h2>
					<div id="h2_title"><?= $this->lang->line_or_def('msg_exam_problem_import_loading','設問へのインポート中') ?></div>
...
<?php } ?>
				...
				<div id="div_import_result">
					...
					<div class="submit">
						<input type="image" src="/static/image/btn_back.png" onClick="location.href='<?=base_url()?>cms_exam_problem_import';return false;" />
					</div>
				</div>
