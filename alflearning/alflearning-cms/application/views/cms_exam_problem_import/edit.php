...
<!--
 ...
 -->
				...
				<?=form_open_multipart("cms_exam_problem_import/confirm")?>
					...
					<?=(isset($lecture_error)?'<div class="error">'.htmlspecialchars($lecture_error, ENT_QUOTES, 'UTF-8', false).'</div>':'')?>
					<?=(isset($local_file_error)?'<div class="error">'.htmlspecialchars($local_file_error, ENT_QUOTES, 'UTF-8', false).'</div>':'')?>
					<table class="form">
						<tr>
									...
									<?php if( isset($exam_problem_groups) ): ?>
										<?php foreach( $exam_problem_groups as $exam_problem_group ): ?>
											<li>
												...
												?>
												<input type="checkbox" name="exam_problem_groups[]" id="groups_<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?>" value=<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?> <?= htmlspecialchars( $checked_flag, ENT_QUOTES, 'UTF-8', false) ?> />
												<label for="groups_<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?>">
													<?= htmlspecialchars( $exam_problem_group['exam_problem_group_name'], ENT_QUOTES, 'UTF-8', false) ?>&nbsp;&nbsp;[<?= $this->lang->line_or_def('common_position_exam_problem_count','所属設問数') ?>&nbsp;:&nbsp;<?= htmlspecialchars( $exam_problem_group['exam_problem_count'], ENT_QUOTES, 'UTF-8', false) ?>]
												</label>
											</li>
										<?php endforeach; ?>
									<?php else: ?>
								...
								<div class="cource_list_ex">
									...
									<?php 
										if( isset($lecture_cources) ) { 
											foreach( $lecture_cources as $cource ){ ?>
												<li>
												<input type="checkbox" name="exam_problem_lectures_ex[]" id="lectures_<?= htmlspecialchars( $cource['cource_id'], ENT_QUOTES, 'UTF-8', false) ?>_ex" value=<?= htmlspecialchars( $cource['cource_id'], ENT_QUOTES, 'UTF-8', false) ?>
													>
							...
							<td>
								<div class="group_list_ex">
									...
									<?php if( isset($exam_problem_groups) ): ?>
										<?php foreach( $exam_problem_groups as $exam_problem_group ): ?>
											<li>
												<input type="checkbox" name="exam_problem_groups_ex[]" id="groups_<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?>_ex" value=<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?> />
												<label for="groups_<?= htmlspecialchars( $exam_problem_group['exam_problem_group_id'], ENT_QUOTES, 'UTF-8', false) ?>_ex">
													<?= htmlspecialchars( $exam_problem_group['exam_problem_group_name'], ENT_QUOTES, 'UTF-8', false) ?>&nbsp;&nbsp;[<?= $this->lang->line_or_def('common_position_exam_problem_count','所属設問数') ?>&nbsp;:&nbsp;<?= htmlspecialchars( $exam_problem_group['exam_problem_count'], ENT_QUOTES, 'UTF-8', false) ?>]
												</label>
											</li>
										<?php endforeach; ?>
