				...
				<?=form_open("cms_student/commit")?>
					...
					<table class="form">
						<tr>
							...
							<td>
								<?= htmlspecialchars( $student['student_name'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_','弁護士番号') ?></th>
							<td>
								<?= htmlspecialchars( $student['lawyer_number'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<?= htmlspecialchars( $student['regist_date'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_','対象パスポート') ?></th>
							<td>
								<?= htmlspecialchars( $student['target_passport'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_','パスポートの有無') ?></th>
							<td>
								<?= htmlspecialchars( $student['presence_passport'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
							<th><?= $this->lang->line_or_def('common_mail_address','メールアドレス') ?></th>
							<td>
								<?= htmlspecialchars( $student['student_email'], ENT_QUOTES, 'UTF-8', false) ?>
							</td>
						</tr>
						<tr>
							...
							<td>
								<?php if(isset($student['mailmagazine_flg'])): ?>
									<?php if( isset($mtb_mailmagazine_flg[$student['mailmagazine_flg']]) ): ?>
										<?= htmlspecialchars( $mtb_mailmagazine_flg[$student['mailmagazine_flg']], ENT_QUOTES, 'UTF-8', false) ?>
									<?php else: ?>
										<?= ''; ?>
									<?php endif; ?>
								<?php endif; ?>
							...
							<td>
								<?php if(isset($student['ethic_training'])): ?>
									<?php if( isset($mtb_ethic_training[$student['ethic_training']]) ): ?>
										<?= htmlspecialchars( $mtb_ethic_training[$student['ethic_training']], ENT_QUOTES, 'UTF-8', false) ?>
									<?php else: ?>
										<?= ''; ?>
									<?php endif; ?>
								<?php endif; ?>
							...
							<td>
								<?php if(isset($student['sub_auth_ethic_training'])): ?>
									<?php if( isset($mtb_sub_auth_ethic_training[$student['sub_auth_ethic_training']]) ): ?>
										<?= htmlspecialchars( $mtb_sub_auth_ethic_training[$student['sub_auth_ethic_training']], ENT_QUOTES, 'UTF-8', false) ?>
									<?php else: ?>
										<?= ''; ?>
									<?php endif; ?>
								<?php endif; ?>
