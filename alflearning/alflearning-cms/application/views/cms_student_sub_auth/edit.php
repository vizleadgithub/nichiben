						...
						<tr>
							...
							<td>
								...
								<?php foreach($mtb_mailmagazine_category as $index => $value): ?>
									...
									?>
									<li>
										<input id="mailmagazine_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" type="checkbox" value="<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" name="mailmagazine_ids_array[]" <?= $selected; ?>>
						...
						<tr>
							...
							<td>
								...
								<?php foreach($mtb_media as $index => $value): ?>
									...
									?>
									<li>
										<input id="media_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" type="checkbox" value="<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" name="media_id_array[]" <?= $selected; ?>>
