									...
									<?php if( isset($exam2_problem_groups) ): ?>
										<?php foreach( $exam2_problem_groups as $exam2_problem_group ): ?>
											<li>
												...
												?>
												<input type="checkbox" name="exam2_problem_groups[]" id="groups_<?= htmlspecialchars( $exam2_problem_group['exam2_problem_group_id'], ENT_QUOTES, 'UTF-8') ?>" value=<?= htmlspecialchars( $exam2_problem_group['exam2_problem_group_id'], ENT_QUOTES, 'UTF-8') ?> <?= $checked_flag ?> />
												<label for="groups_<?= htmlspecialchars( $exam2_problem_group['exam2_problem_group_id'], ENT_QUOTES, 'UTF-8') ?>">
