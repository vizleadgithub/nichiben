							...
							<td align = "left">
								<ul>
									...
									<? foreach($school_list as $school): ?>
										<? if($school['contract'] == 'fixation'): ?><li><input type="radio" name="school_id" value="<?= htmlspecialchars( $school['school_id'], ENT_QUOTES, 'UTF-8', false) ?>" /><?= htmlspecialchars( $school['school_name'], ENT_QUOTES, 'UTF-8', false) ?></li><? endif; ?>
									<? endforeach; ?>
									<? endif; ?>
								</ul>
							</td>
						...
						<tr>
							...
							<td align = "left">
								<ul>
									<? if($school_list): ?>
									<? foreach($school_list as $school): ?>
										<? if($school['contract'] == 'demo'): ?><li><input type="radio" name="school_id" value="<?= htmlspecialchars( $school['school_id'], ENT_QUOTES, 'UTF-8', false) ?>" /><?= htmlspecialchars( $school['school_name'], ENT_QUOTES, 'UTF-8', false) ?></li><? endif; ?>
									<? endforeach; ?>
									<? endif; ?>
								</ul>
							</td>
						...
						<tr>
							...
							<td align = "left">
								<ul>
									<? if($school_list): ?>
									<? foreach($school_list as $school): ?>
										<? if($school['contract'] == 'presentation'): ?><li><input type="radio" name="school_id" value="<?= htmlspecialchars( $school['school_id'], ENT_QUOTES, 'UTF-8', false) ?>" /><?= htmlspecialchars( $school['school_name'], ENT_QUOTES, 'UTF-8', false) ?></li><? endif; ?>
									<? endforeach; ?>
									<? endif; ?>
								</ul>
							</td>
