		...
		<h1 class="claerfix">
			...
			<div class="comment">
				<?php if($select_tag===''): ?>
					新着
				<?php else: ?>
					<?= $this->lang->line_or_def('common_tag','タグ') ?>&nbsp;:&nbsp;<?= htmlspecialchars( $select_tag, ENT_QUOTES, 'UTF-8', false) ?>
				<?php endif; ?>
			</div>
		</h1>
					...
					?>
						<li>
							<h2 style="text-align: left;">
								[<?= htmlspecialchars( $information['information_id'], ENT_QUOTES, 'UTF-8', false) ?>]&nbsp;<?= htmlspecialchars( $information['information_date'], ENT_QUOTES, 'UTF-8', false) ?>&nbsp;&nbsp;
								...
								<span style="display: block;float: right;height: 25px;line-height: 25px;">
									<?= htmlspecialchars( $information['information_open'], ENT_QUOTES, 'UTF-8', false) ?><?= $this->lang->line_or_def('common_range','～') ?><?= htmlspecialchars( $information['information_close'], ENT_QUOTES, 'UTF-8', false) ?>&nbsp;&nbsp;
								</span>
							</h2>
							<table id="information_table" style=<?= ($information['school_id']==0) ? "background-color:#D3F5EA;" : ""; ?> >
								...
								<tr>
									...
									<td class="information_detail"><?= nl2br( htmlspecialchars( $information['information_caption'], ENT_QUOTES, 'UTF-8', false) ) ?></td>
								</tr>
								<tr>
									...
									<td class="information_detail">
										...
										<?php else: ?>
											...
											<?php else: ?>
												<?= htmlspecialchars( $information['information_tags'], ENT_QUOTES, 'UTF-8', false) ?>
											<?php endif; ?>
										<?php endif; ?>
									</td>
								</tr>
