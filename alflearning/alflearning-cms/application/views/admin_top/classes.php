			...
			<div id="contents_main">
				...
				<table class="list">
					...
					<?php
						...
						?>
								<tr>
									<td><?= htmlspecialchars( $class['class_id'], ENT_QUOTES, 'UTF-8', false) ?></td>
									...
									<td><?= $this->lang->line_or_def('common_last','あと') ?><?= htmlspecialchars( $class['fixed_number'], ENT_QUOTES, 'UTF-8', false) ?><?= $this->lang->line_or_def('common_people','人') ?></td>
