		...
		<div id="main">
			...
			<div id="contents_main">
				...
				<div class="submit">
					...
					<a href="/cms_report/cms_user_detail/<?= htmlspecialchars( $student['student_id'], ENT_QUOTES, 'UTF-8') ?>/2" class="on_select_button "><?= $this->lang->line_or_def('common_','日弁連以外主催'); ?></a>
