				...
				<?=form_open_multipart("cms_exam_problem/confirm")?>
					...
					<table class="form">
						<tr>
							...
							<td>
								<input type=text name="exam_problem_name" maxlength="256" size="30" value='<?=set_value('exam_problem_name',$exam_problem['exam_problem_name'])?>'>
							</td>
						</tr>
...
<?php } ?>
						...
						<tr>
							...
							<td>
								<? // 設問種類に応じて表示切替 ?>
								<textarea name="problem_contents_text" id="problem_contents_text" ><?=set_value('problem_contents_text',$exam_problem['problem_contents_text'])?></textarea>
						...
						<tr>
							...
							<td>
								<textarea name="problem_note" id="problem_note" style="height: 80px; width: 65%;"><?=set_value('problem_note',$exam_problem['problem_note'])?></textarea>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<div id="answer_contents_choice" name="answer_contents_choice">
									<ul id="answer_contents_choice_area">
										...
										<?php foreach($exam_problem['answer_contents_no'] as $ino => $answer_contents_no): ?>
											...
											<input type="hidden" name="answer_contents_no[]" value='<?=htmlspecialchars((string)$exam_problem['answer_contents_no'][$ino], ENT_QUOTES, 'UTF-8')?>' />
											<div class="div_word">
												<textarea name="answer_contents_word[]" class="answer_contents_word"><?=htmlspecialchars((string)$exam_problem['answer_contents_word'][$ino], ENT_QUOTES, 'UTF-8')?></textarea>
												</div>
								...
								<textarea name="answer_contents_text" id="answer_contents_text"><?=set_value('answer_contents_text',$exam_problem['answer_contents_text'])?></textarea>
							</td>
						</tr>
						...
						<tr name="tr_answer_explain_contents" style="<?= ($exam_problem['answer_explain_kind'] == 9) ? "display:none" : ""; ?>;">
							...
							<td>
								<? // 設問種類に応じて表示切替 ?>
								<textarea name="answer_explain_contents_text" id="answer_explain_contents_text" ><?=set_value('answer_explain_contents_text',$exam_problem['answer_explain_contents_text'])?></textarea>
						...
						<tr name="tr_answer_explain_note" style="<?= ($exam_problem['answer_explain_kind'] == 9) ? "display:none" : ""; ?>">
							...
							<td>
								<textarea name="answer_explain_note" id="answer_explain_note" style="height: 80px; width: 65%;"><?=set_value('answer_explain_note',$exam_problem['answer_explain_note'])?></textarea>
							</td>
						</tr>
