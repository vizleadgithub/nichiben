		...
		<div id="main">
			...
			<div id="contents_main">
				<div class="toolbar clearfix">
					...
					<? if(isset($exam2_problem_id)): ?>
						<a class="btn_copy_newdata" href="/cms_exam2_problem/newdata/<?= $exam2_problem_id; ?>"><span><?= $this->lang->line_or_def('common_reproduce_new_registration','複製して新規登録') ?></span></a>
					<? endif; ?>
				</div>
				<h2><?= $this->lang->line_or_def('msg_exam2_problem_commit','設問情報更新') ?></h2>
				<h3><?= $this->lang->line_or_def('msg_commit_detail','正常に完了しました。') ?></h3>

				<div class="submit">
					<a href="<?=site_url('cms_exam2_problem')?>"><?= $this->lang->line_or_def('common_back','戻る') ?></a>
				</div>
			</div>
			<div class="clear"></div>
		</div>
