				...
				<?=form_open_multipart("cms_exam2_problem_group/confirm")?>
					...
					<table class="form">
						<tr>
							...
							<td>
								<input type=text name="exam2_problem_group_name" maxlength="256" size="30" value='<?= htmlspecialchars(set_value('exam2_problem_group_name', $exam2_problem_group['exam2_problem_group_name'], FALSE), ENT_QUOTES, 'UTF-8', false) ?>'>
							</td>
						</tr>
						<tr>
							<th style="vertical-align: top;"><?= $this->lang->line_or_def('common_caption','説明') ?></th>
							<td >
								<textarea name="exam2_problem_group_caption" ><?= htmlspecialchars(set_value('exam2_problem_group_caption', $exam2_problem_group['exam2_problem_group_caption'], FALSE), ENT_QUOTES, 'UTF-8', false) ?></textarea>
							</td>
						</tr>
						<tr>
							<th>
							...
							<td>
								...
								<div style="float: right; margin-top: 6px; margin-right: 10px;">
									<label id="exam2_problem_count">
										<?= $this->lang->line_or_def('common_indication','表示') ?>:0&nbsp;/&nbsp;<?= $this->lang->line_or_def('common_total','総') ?>:<?= htmlspecialchars( $exam2_problem_group['exam2_problem_all_count'], ENT_QUOTES, 'UTF-8', false) ?>
									</label>
