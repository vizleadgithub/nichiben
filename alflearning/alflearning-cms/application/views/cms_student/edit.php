									...
									<?php 
										if( isset($lecture_cources) ) { 
											foreach( $lecture_cources as $cource ){ ?>
												<li>
												<input type="checkbox" name="student_lectures[]" id="lectures_<?= htmlspecialchars( $cource['cource_id'], ENT_QUOTES, 'UTF-8', false) ?>" value=<?= htmlspecialchars( $cource['cource_id'], ENT_QUOTES, 'UTF-8', false) ?>
													<?php 
						...
						<tr>
							...
							<td>
								...
								<?php foreach($mtb_mailmagazine_category as $index => $value): ?>
									...
									?>
									<li>
										<input id="mailmagazine_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" type="checkbox" value="<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" name="mailmagazine_ids_array[]" <?= htmlspecialchars( $selected, ENT_QUOTES, 'UTF-8', false) ?>>
										<label for="mailmagazine_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>"><?= htmlspecialchars( $value, ENT_QUOTES, 'UTF-8', false) ?></label>
									</li>
								<?php endforeach; ?>
								</ul>
							</td>
						...
						<tr>
							...
							<td>
								...
								<?php foreach($mtb_media as $index => $value): ?>
									...
									?>
									<li>
										<input id="media_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" type="checkbox" value="<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>" name="media_id_array[]" <?= htmlspecialchars( $selected, ENT_QUOTES, 'UTF-8', false) ?>>
										<label for="media_category_<?= htmlspecialchars( $index, ENT_QUOTES, 'UTF-8', false) ?>"><?= htmlspecialchars( $value, ENT_QUOTES, 'UTF-8', false) ?></label>
									</li>
								<?php endforeach; ?>
								</ul>
