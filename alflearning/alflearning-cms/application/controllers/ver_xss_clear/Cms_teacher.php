...
//	);
	...
	function confirm(){
		...
		$this->form_validation->set_rules('teacher_id'              , $this->lang->line_or_def('common_id','ID')                                   , 'trim|xss_clean|numeric');
		$this->form_validation->set_rules('teacher_name'            , $this->lang->line_or_def('common_name','名前')                               , 'trim|xss_clean|required|callback_name_check');
		$this->form_validation->set_rules('teacher_email'           , $this->lang->line_or_def('common_mail_address','メールアドレス')             , 'trim|xss_clean|required|valid_email');

		if( 
			    $this->input->post('update_flg') != 0
			 && $this->input->post('teacher_password_change') == 1 
		){
			$this->form_validation->set_rules('teacher_password_old'    , $this->lang->line_or_def('common_password_old','現在のパスワード')           , 'trim|xss_clean|required');
			$this->form_validation->set_rules('teacher_password'        , $this->lang->line_or_def('common_password_new','新パスワード')                   , 'trim|xss_clean|required|callback_password_policy');
			$this->form_validation->set_rules('teacher_password_check'  , $this->lang->line_or_def('common_password_new_conf','新パスワード（確認入力）')  , 'trim|xss_clean|required|matches[teacher_password]');
		}
		if( $this->input->post('update_flg') == 0 ){
			$this->form_validation->set_rules('teacher_password'        , $this->lang->line_or_def('common_password','パスワード')                   , 'trim|xss_clean|required|callback_password_policy');
			$this->form_validation->set_rules('teacher_password_check'  , $this->lang->line_or_def('common_password_conf','パスワード（確認入力）')  , 'trim|xss_clean|required|matches[teacher_password]');
		}

		$this->form_validation->set_rules('teacher_auth'            , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('teacher_introduce'       , $this->lang->line_or_def('common_self_introduction_summary','自己紹介 概要') , 'trim|xss_clean');
		$this->form_validation->set_rules('teacher_introduce_detail', $this->lang->line_or_def('common_self_introduction_detail','自己紹介 詳細')  , 'trim|xss_clean');
		$this->form_validation->set_rules('teacher_note'            , $this->lang->line_or_def('common_note','備考')                               , 'trim|xss_clean');
		$this->form_validation->set_rules('a_cource_class'          , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_student'               , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_teacher'               , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_material'              , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_information'           , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_book_library'          , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_video'                 , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
		$this->form_validation->set_rules('a_issue'                 , $this->lang->line_or_def('common_practice_authority','実行権限')             , 'trim|xss_clean');
	...
	function photo_upload_exec(){
		...
		//検証ルールの設定
		$this->form_validation->set_rules('teacher_id'   , $this->lang->line_or_def('common_id','ID')     , 'trim|xss_clean|required|numeric');
		$this->form_validation->set_rules('teacher_name' , $this->lang->line_or_def('common_name','名前') , 'trim|xss_clean');
