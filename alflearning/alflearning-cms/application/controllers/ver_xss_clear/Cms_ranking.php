...
//		}
	...
	function index($offset=0){
		...
		$this->form_validation->set_rules('result' , $this->lang->line_or_def('result','result') , 'trim|xss_clean');
	...
	function confirm(){
		...
		$this->form_validation->set_rules('product_id_1', $this->lang->line_or_def('common_ranking_product_id_1','1位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_2', $this->lang->line_or_def('common_ranking_product_id_2','2位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_3', $this->lang->line_or_def('common_ranking_product_id_3','3位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_4', $this->lang->line_or_def('common_ranking_product_id_4','4位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_5', $this->lang->line_or_def('common_ranking_product_id_5','5位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_6', $this->lang->line_or_def('common_ranking_product_id_6','6位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_7', $this->lang->line_or_def('common_ranking_product_id_7','7位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_8', $this->lang->line_or_def('common_ranking_product_id_8','8位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_9', $this->lang->line_or_def('common_ranking_product_id_9','9位の商品'), 'trim|xss_clean|numeric|required');
		$this->form_validation->set_rules('product_id_10', $this->lang->line_or_def('common_ranking_product_id_10','10位の商品'), 'trim|xss_clean|numeric|required');

		$this->form_validation->set_rules('file_text1', 'file_text1', 'trim|xss_clean');
		$this->form_validation->set_rules('file_name1', 'file_name1', 'trim|xss_clean');
		$this->form_validation->set_rules('file_path1', 'file_path1', 'trim|xss_clean');
		$this->form_validation->set_rules('file_text2', 'file_text2', 'trim|xss_clean');
		$this->form_validation->set_rules('file_name2', 'file_name2', 'trim|xss_clean');
		$this->form_validation->set_rules('file_path2', 'file_path2', 'trim|xss_clean');
		$this->form_validation->set_rules('file_text3', 'file_text3', 'trim|xss_clean');
		$this->form_validation->set_rules('file_name3', 'file_name3', 'trim|xss_clean');
		$this->form_validation->set_rules('file_path3', 'file_path3', 'trim|xss_clean');
