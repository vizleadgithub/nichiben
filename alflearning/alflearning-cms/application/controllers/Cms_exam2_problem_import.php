...
//		}
	...
	//	$this->load->model('model_exam2_problem');
		...
		$check_exam2_problem_lectures = $this->input->post('exam2_problem_lectures');
		$check_exam2_problem_groups   = $this->input->post('exam2_problem_groups');
		$check_exam2_problem_lectures = is_null($check_exam2_problem_lectures) ? array() : $check_exam2_problem_lectures;
		$check_exam2_problem_groups   = is_null($check_exam2_problem_groups) ? array() : $check_exam2_problem_groups;

		if(!is_array($check_exam2_problem_lectures) || !is_array($check_exam2_problem_groups) || !check_array_data_num(array($check_exam2_problem_lectures, $check_exam2_problem_groups))){
			$this->lang->load('error');
...
//			}
			...
			if($this->form_validation->run() == FALSE || (isset($_FILES['local_file']) && $_FILES['local_file']['error'] != 0) || ($lecture_error_msg != "") || ($local_file_error_msg != "")){
				...
				$data['exam2_problem']['exam2_problem_lectures'] = $check_exam2_problem_lectures;
				$data['exam2_problem']['exam2_problem_groups']   = $check_exam2_problem_groups;
				$data['exam2_problem']['local_file']            = '';
