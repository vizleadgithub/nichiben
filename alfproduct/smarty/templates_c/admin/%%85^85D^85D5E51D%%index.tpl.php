<?php /* Smarty version 2.6.31, created on 2024-12-20 15:52:09
         compiled from /srv/alfproduct/smarty/templates/admin/amount_order/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/amount_order/index.tpl', 4, false),array('modifier', 'urlencode', '/srv/alfproduct/smarty/templates/admin/amount_order/index.tpl', 91, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['row']['name']; ?>
		...
		<tr>
			<th>商品コード</th>
			<td>
				<input type="text" name="search_product_code" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['search_product_code'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
			...
			<td class="tdc" colspan="6">
				<div>
					<div style="width:100%;float:left;">
						<div style="float:left;width:100px;text-align:left;padding: 1px 3px;"><a href="info.php?oid=<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['order_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['order_no'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a></div>
						<div style="float:left;width:160px;text-align:left;padding: 1px 3px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['student_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</div>
						<div style="float:left;width:100px;text-align:left;padding: 1px 3px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['lawyer_number'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</div>
						<div style="float:left;width:120px;text-align:left;padding: 1px 3px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['association_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</div>
						<div style="float:left;width:160px;text-align:left;padding: 1px 3px;"><?php if ($this->_tpl_vars['row']['product_name_TOD'] != ""): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_name_TOD'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endif; ?></div>
						<div style="float:left;width:;text-align:left;padding: 1px 3px;"><?php if ($this->_tpl_vars['row']['product_code_TOD'] != ""): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_code_TOD'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endif; ?></div>
					...
					<div style="width:100%;float:left;">
						...
						<?php elseif ($this->_tpl_vars['row']['payment_status'] == '3'): ?>一部入金
						<?php elseif ($this->_tpl_vars['row']['payment_status'] == '9'): ?>キャンセル
						<?php endif; ?>
						</div>
						<div style="float:left;width:160px;text-align:left;padding: 1px 3px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['create_date'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</div>
						<div style="float:left;width:100px;text-align:left;padding: 1px 3px;">
						...
						<div style="float:left;width:160px;text-align:left;padding: 1px 3px;"><?php if ($this->_tpl_vars['row']['payment_type'] == '1'): ?><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['order_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
<?php else: ?>-<?php endif; ?></div>
						<div style="float:left;width:;text-align:left;padding: 1px 3px;"><?php if ($this->_tpl_vars['row']['claim_flg'] == '1'): ?>○<?php else: ?>×<?php endif; ?></div>
					</div>
				</div>
			</td>
		</tr>
