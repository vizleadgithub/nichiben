<?php /* Smarty version 2.6.31, created on 2025-02-07 12:24:27
         compiled from /srv/alfproduct/smarty/templates/admin/product_ethics/search_contents.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/product_ethics/search_contents.tpl', 8, false),array('modifier', 'urlencode', '/srv/alfproduct/smarty/templates/admin/product_ethics/search_contents.tpl', 39, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/admin/product_ethics/search_contents.tpl', 35, false),)), $this); ?>
...
?>
	...
	<tr style="">
		<td class="tdc" style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background: none repeat scroll 0% 0% rgb(246, 246, 243);<?php endif; ?>"><?php echo $this->_tpl_vars['row']['video_id']; ?>
</td>
		<td class="tdc" style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background: none repeat scroll 0% 0% rgb(246, 246, 243);<?php endif; ?>"><?php echo $this->_tpl_vars['row']['video_logic_name']; ?>
</td>
