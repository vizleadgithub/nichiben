<?php /* Smarty version 2.6.31, created on 2025-02-07 07:39:58
         compiled from /srv/alfproduct/smarty/templates/admin/product_lecture/info.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/product_lecture/info.tpl', 34, false),array('modifier', 'number_format', '/srv/alfproduct/smarty/templates/admin/product_lecture/info.tpl', 34, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/admin/product_lecture/info.tpl', 62, false),)), $this); ?>
<!--
...
">CSV取得</a>
		...
		<tr>
			...
			<th>料金（テキスト代含む）</th>
			<td style="width:70%">
				<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arr_input']['price'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('number_format', true, $_tmp) : number_format($_tmp)); ?>
円
			</td>
		</tr>
	</table>
