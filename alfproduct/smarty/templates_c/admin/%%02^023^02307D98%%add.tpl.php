<?php /* Smarty version 2.6.31, created on 2025-03-07 15:17:46
         compiled from /srv/alfproduct/smarty/templates/admin/product/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/product/add.tpl', 33, false),array('modifier', 'count', '/srv/alfproduct/smarty/templates/admin/product/add.tpl', 125, false),array('modifier', 'cat', '/srv/alfproduct/smarty/templates/admin/product/add.tpl', 450, false),array('function', 'html_checkboxes', '/srv/alfproduct/smarty/templates/admin/product/add.tpl', 409, false),)), $this); ?>
...
" />
	...
	<tr>
		...
		<td>
			<label><input type="radio" name="product_kind_flg" value="1" <?php if ($this->_tpl_vars['arr_input']['product_kind_flg'] == 1): ?>checked<?php endif; ?> />eラーニング</label>
			<label>
			<input type="radio" name="product_kind_flg" value="2" <?php if ($this->_tpl_vars['arr_input']['product_kind_flg'] == 2): ?>checked<?php endif; ?> />e-ライブ
			<span id="spa_live_training_product_id" ><?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['live_training_product_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</span>
			<input type="hidden" name="live_training_product_id" id="hid_live_training_product_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['live_training_product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
			<input type="hidden" name="live_training_product_name" id="hid_live_training_product_id_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['live_training_product_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
			...
			<label><input type="radio" name="product_kind_flg" value="0" <?php if ($this->_tpl_vars['arr_input']['product_kind_flg'] === '0'): ?>checked<?php endif; ?> />その他</label>
			<label><input type="radio" name="product_kind_flg" value="3" <?php if ($this->_tpl_vars['arr_input']['product_kind_flg'] === '3'): ?>checked<?php endif; ?> />設問付きeラーニング</label>
		</td>
	</tr>
	<tr>
...
" />
	...
	<tr>
		...
		<td>
			...
			[<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['teacher_student']['lawyer_number'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
]
			<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['teacher_student']['student_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

			<?php endif; ?>
			</span>
			<input type="hidden" name="teacher_student_id" id="hid_teacher_student_id" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['teacher_student_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
			<input type="hidden" name="teacher_student_name" id="hid_teacher_student_id_name" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['teacher_student_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
	...
	<tr>
		...
		<td>
			<?php echo smarty_function_html_checkboxes(array('name' => 'product_flg','options' => $this->_tpl_vars['arr_product_flg'],'checked' => ((is_array($_tmp=$this->_tpl_vars['arr_input']['product_flg'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))), $this);?>
	...
	<tr>
		...
		<td>
			<?php echo smarty_function_html_checkboxes(array('name' => 'product_disp_warning_word','options' => $this->_tpl_vars['arr_product_disp_warning_word'],'checked' => ((is_array($_tmp=$this->_tpl_vars['arr_input']['product_disp_warning_word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp))), $this);?>
	...
	<tr>
		...
		<td>
			<textarea name="search_word" id="search_word" style="width:520px;height:150px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['search_word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea>
		</td>
	</tr>
	<tr>
...
')" />
	...
	<tr>
		<th style="vertical-align:middle;">コンテンツ<?php echo $this->_sections['contents_loop']['index']; ?>
音声コンテンツ<?php if ($this->_sections['contents_loop']['index'] == '1'): ?><?php endif; ?></th>
		<td>
			<?php $this->assign('contents_contents_so_key', ((is_array($_tmp=((is_array($_tmp='contents_contents')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_sections['contents_loop']['index']) : smarty_modifier_cat($_tmp, $this->_sections['contents_loop']['index'])))) ? $this->_run_mod_handler('cat', true, $_tmp, 'so') : smarty_modifier_cat($_tmp, 'so'))); ?>
			...
			<?php if ($this->_tpl_vars['contents_contents_so_key'] != ""): ?><input type="text" name="<?php echo $this->_tpl_vars['contents_contents_so_name_key']; ?>
" id="hid_<?php echo $this->_tpl_vars['contents_contents_so_name_key']; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input'][$this->_tpl_vars['contents_contents_so_name_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /><?php endif; ?>
			<input type="hidden" name="<?php echo $this->_tpl_vars['contents_contents_so_key']; ?>
" id="hid_<?php echo $this->_tpl_vars['contents_contents_so_key']; ?>
" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input'][$this->_tpl_vars['contents_contents_so_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" />
			<input type="button" value="検索" onclick="searchButton('search_contents_so.php?gid=<?php echo $this->_tpl_vars['contents_contents_so_key']; ?>
')" />
		</td>
	</tr>
...
" />
	...
	<tr>
		...
		<td>
			...
			<select name="<?php echo $this->_tpl_vars['exam_id_test_key']; ?>
" id="<?php echo $this->_tpl_vars['exam_id_test_key']; ?>
">
				<option value=""></option>
...
?>
					<option value="<?php echo $this->_tpl_vars['exam']['exam_id']; ?>
" <?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['exam_id_test_key']] == $this->_tpl_vars['exam']['exam_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['exam']['exam_name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
			</select>
		</td>
	...
	<tr>
		...
		<td>
			...
			<select name="<?php echo $this->_tpl_vars['exam_id_question_key']; ?>
" id="<?php echo $this->_tpl_vars['exam_id_question_key']; ?>
">
				<option value=""></option>
				<?php $_from = $this->_tpl_vars['exam_list']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['exam']):
?>
					<option value="<?php echo $this->_tpl_vars['exam']['exam_id']; ?>
" <?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['exam_id_question_key']] == $this->_tpl_vars['exam']['exam_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['exam']['exam_name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
			</select>
		</td>
	...
	<tr>
		...
		<td>
			...
			<select name="<?php echo $this->_tpl_vars['btn_type_key']; ?>
" id="<?php echo $this->_tpl_vars['btn_type_key']; ?>
">
				<option value=""></option>
...
?>
					<option value="<?php echo $this->_tpl_vars['btn_type_id']; ?>
" <?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['btn_type_key']] == $this->_tpl_vars['btn_type_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['btn_type_name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
			</select>
		</td>
	...
	<tr>
		...
		<td>
			...
			<label><input type="checkbox" name="<?php echo $this->_tpl_vars['disp_warning_word_key']; ?>
" value="3" <?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['disp_warning_word_key']] == '3'): ?>checked<?php endif; ?>>テストボタン右</label>
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<?php endfor; endif; ?>
	...
	<tr>
		...
		<td>
			<?php $this->assign('exam2_id_key', 'exam2_id'); ?>
			<select name="<?php echo $this->_tpl_vars['exam2_id_key']; ?>
" id="<?php echo $this->_tpl_vars['exam2_id_key']; ?>
">
				<option value=""></option>
...
?>
					<option value="<?php echo $this->_tpl_vars['exam2']['exam2_id']; ?>
" <?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['exam2_id_key']] == $this->_tpl_vars['exam2']['exam2_id']): ?>selected<?php endif; ?>><?php echo $this->_tpl_vars['exam2']['exam2_name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
			</select>
		</td>
