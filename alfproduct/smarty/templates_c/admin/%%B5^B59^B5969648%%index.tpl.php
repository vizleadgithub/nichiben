<?php /* Smarty version 2.6.31, created on 2025-09-19 14:52:23
         compiled from /srv/alfproduct/smarty/templates/admin/report_product/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/report_product/index.tpl', 8, false),array('modifier', 'count', '/srv/alfproduct/smarty/templates/admin/report_product/index.tpl', 71, false),array('modifier', 'urlencode', '/srv/alfproduct/smarty/templates/admin/report_product/index.tpl', 209, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/admin/report_product/index.tpl', 225, false),)), $this); ?>
...
" <?php if ($this->_tpl_vars['row']['id'] == $this->_tpl_vars['search_association']): ?> selected<?php endif; ?> ><?php echo $this->_tpl_vars['row']['name']; ?>
</option>
				<?php endforeach; endif; unset($_from); ?>
				</select>
			</td>
...
件中）
	<table class="list">
		...
		<tr>
			...
			<th style="width:;">実施日</th>
			<th style="width:;">総受講者（受講完了者）</th>
			<th style="width:;">受付期間</th>
		</tr>
...
?>
		...
		<tr style="">
			<?php if ($this->_tpl_vars['row']['product_type_add'] == '1'): ?>
				<td class="tdc" style=""><a href="info.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
			...
			<?php elseif ($this->_tpl_vars['row']['product_type_add'] == '2'): ?>
				<td class="tdc" style=""><a href="info.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
&aid=<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['bar_association_branch_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
			...
			<?php endif; ?>
			<td class="tdc"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
			<td class="tdc"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_code'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
			<td class="tdc">
								<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['bar_association_branch_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

			</td>
			<td class="tdc"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['dates'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
			<td class="tdc">
			<?php if ($this->_tpl_vars['row']['product_type_add'] == '1'): ?>
				<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add1_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

				(<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add1_end_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)名
			<?php elseif ($this->_tpl_vars['row']['product_type_add'] == '2'): ?>
				<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add2_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

				(<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add2_end_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)名
			<?php elseif ($this->_tpl_vars['row']['product_type_add'] == '3'): ?>
				<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add3_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

				(<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_type_add3_end_count'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
)名
			<?php elseif ($this->_tpl_vars['row']['product_type_add'] == '4'): ?>
			<?php endif; ?>
			</td>
			<td class="tdc">
				<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['start_date'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

				<?php if ($this->_tpl_vars['row']['start_date'] == "" && $this->_tpl_vars['row']['end_date'] == ""): ?><?php else: ?>～<?php endif; ?>
				<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['end_date'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
