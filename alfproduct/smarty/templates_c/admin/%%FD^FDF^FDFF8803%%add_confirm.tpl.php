<?php /* Smarty version 2.6.31, created on 2025-03-03 16:57:26
         compiled from /srv/alfproduct/smarty/templates/admin/product/add_confirm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/product/add_confirm.tpl', 18, false),array('modifier', 'cat', '/srv/alfproduct/smarty/templates/admin/product/add_confirm.tpl', 35, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/admin/product/add_confirm.tpl', 257, false),)), $this); ?>
...
" />
	...
	<tr>
		...
		<td>
			...
			<?php if ($this->_tpl_vars['arr_input']['product_kind_flg'] == '2'): ?>
			e-ライブ<br />
			<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input']['live_training_product_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
説明</th>
	...
	<tr>
		...
		<td>
			...
			<?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['exam_id_test_key']] == ''): ?>
				未設定
			<?php else: ?>
...
<?php endif; ?>
	...
	<tr>
		...
		<td>
			...
			<?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['exam_id_question_key']] == ''): ?>
				未設定
			<?php else: ?>
				<?php $_from = $this->_tpl_vars['exam_list']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['exam']):
...
<?php endif; ?>
	...
	<tr>
		...
		<td>
			...
			<?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['btn_type_key']] == ''): ?>
				未設定
			<?php else: ?>
...
-<?php echo $this->_sections['contents_download']['index']; ?>
			...
			<td>
				<?php $this->assign('contents_download_name_key', ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp='contents_download_before')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_sections['contents_loop']['index']) : smarty_modifier_cat($_tmp, $this->_sections['contents_loop']['index'])))) ? $this->_run_mod_handler('cat', true, $_tmp, '_') : smarty_modifier_cat($_tmp, '_')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_sections['contents_download']['index']) : smarty_modifier_cat($_tmp, $this->_sections['contents_download']['index']))); ?>
				<?php if ($this->_tpl_vars['arr_input'][$this->_tpl_vars['contents_download_name_key']] == ''): ?>
					未設定
				<?php else: ?>
					<?php echo ((is_array($_tmp=$this->_tpl_vars['arr_input'][$this->_tpl_vars['contents_download_name_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endfor; endif; ?>
	...
	<tr>
		...
		<td>
			<?php if ($this->_tpl_vars['arr_input']['exam2_id'] == ''): ?>
				未設定
			<?php else: ?>
