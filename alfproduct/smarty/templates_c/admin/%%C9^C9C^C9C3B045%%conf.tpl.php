<?php /* Smarty version 2.6.31, created on 2025-01-24 11:07:17
         compiled from /srv/alfproduct/smarty/templates/admin/inquiry/conf.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/inquiry/conf.tpl', 10, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/admin/inquiry/conf.tpl', 34, false),)), $this); ?>
<div class="toolbar clearfix">
	...
	<table class="form">
		...
		<tr>
			...
			<td style="">
				<?php echo ((is_array($_tmp=$this->_tpl_vars['return_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
		...
		<tr>
			...
			<td style="">
				<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['return_comment'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
">
			<input type="hidden" name="return_title" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['return_title'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
			<input type="hidden" name="return_comment" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['return_comment'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
