<?php /* Smarty version 2.6.31, created on 2025-01-24 10:53:26
         compiled from /srv/alfproduct/smarty/templates/admin/product/search_product_ranking.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/admin/product/search_product_ranking.tpl', 8, false),array('modifier', 'count', '/srv/alfproduct/smarty/templates/admin/product/search_product_ranking.tpl', 50, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/admin/product/search_product_ranking.tpl', 199, false),)), $this); ?>
...
～<?php echo $this->_tpl_vars['row']['end_date']; ?>
		...
		<td class="tdc" style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background: none repeat scroll 0% 0% rgb(246, 246, 243);<?php endif; ?>"><a href="search_product_ranking_set.php?rank_i=<?php echo $this->_tpl_vars['rank_i']; ?>
&pid=<?php echo $this->_tpl_vars['row']['product_id']; ?>
&pname=<?php echo $this->_tpl_vars['row']['product_name']; ?>
">この商品を設定する</a></td>
	</tr>
	<?php endforeach; endif; unset($_from); ?>
	<tr>
