<?php /* Smarty version 2.6.31, created on 2025-04-02 20:28:27
         compiled from /srv/alfproduct/smarty/templates/default/mypage/viewing.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/mypage/viewing.tpl', 24, false),array('function', 'html_options', '/srv/alfproduct/smarty/templates/default/mypage/viewing.tpl', 47, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/default/mypage/viewing.tpl', 69, false),)), $this); ?>
...
<?php else: ?>掲載終了しました。<?php endif; ?></td>
					<td style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['total_duration'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
...
" style="color:#796A57;">講座詳細へ</a><?php else: ?>公開終了<?php endif; ?></td>
				</tr>
				<tr style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>">
					<td style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">受講率<br /><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['max_percent'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
%</td>
					<td style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><?php echo ((is_array($_tmp=$this->_tpl_vars['val']['all_remaining'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
