<?php /* Smarty version 2.6.31, created on 2025-04-07 13:14:51
         compiled from /srv/alfproduct/smarty/templates/default/exam/confirm1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/exam/confirm1.tpl', 108, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/default/exam/confirm1.tpl', 117, false),)), $this); ?>
<style type="text/css">
...
" disabled <?php if ($this->_tpl_vars['row1_q']['no'] == $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'][0]): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1_q']; ?>
.</div>
...
<?php endif; ?>"><?php if ($this->_tpl_vars['btn_type_q'] == '2'): ?>回答修正画面へ<?php else: ?>解答修正画面へ<?php endif; ?></a>
			...
			<?php if ($this->_tpl_vars['hantei_ari']): ?>
...
※不正解と表示された設問の解答を修正して下さい（「確認する」→「解答修正画面へ」をクリック）。<br>
			...
			<div style="text-align:center;padding:10px;">
				<a class="btn" href="/exam/answer_save1.php?eid=<?php echo $this->_tpl_vars['eid']; ?>
