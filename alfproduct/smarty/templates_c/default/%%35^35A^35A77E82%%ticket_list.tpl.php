<?php /* Smarty version 2.6.31, created on 2025-04-02 19:47:19
         compiled from /srv/alfproduct/smarty/templates/default/mypage/ticket_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/mypage/ticket_list.tpl', 25, false),array('modifier', 'number_format', '/srv/alfproduct/smarty/templates/default/mypage/ticket_list.tpl', 69, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/default/mypage/ticket_list.tpl', 65, false),)), $this); ?>
...
円</td>
					<td rowspan="2" style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">
						<?php if ($this->_tpl_vars['val']['download_ok'] == 1): ?>
							<?php if ($this->_tpl_vars['val']['del_flg'] === '0'): ?><a href="/product/detail.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['val']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" style="color:#796A57;">詳細</a><?php endif; ?>
						<?php endif; ?>
					</td>
					<td rowspan="2" style="<?php if ($this->_tpl_vars['cycle_bg'] == '1'): ?>background-color: #F5F5F5;<?php else: ?>background-color: #FFFFFF;<?php endif; ?>border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">
						<?php if ($this->_tpl_vars['val']['download_ok'] == 1): ?>
