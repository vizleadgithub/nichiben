<?php /* Smarty version 2.6.27, created on 2023-05-19 16:55:38
         compiled from /srv/alfproduct/smarty/templates/default/ethic_treaning/question_retry.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', '/srv/alfproduct/smarty/templates/default/ethic_treaning/question_retry.tpl', 28, false),)), $this); ?>
...
<div style="float:right;width:980px;border: solid 1px #EDECE0;background-color:#FFFFFF;">
	...
	<div style="float:left;width:910px;margin-left:25px;margin-top:20px;border: solid 1px #EDECE0;border-style: none none solid;">
		<?php if ($this->_tpl_vars['answer_btn_disp_flg']): ?>
			...
			<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:880px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
				<form action="/ethic_treaning/question_answer_retry.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
...
" method="post" name="form_answer">
					...
					<ul style="text-align:center;padding:20px;list-style:none;padding-left:280px;">
						<li style="float:left;padding:0 20px;"><a href="javascript:void(0);" onclick="javascript:location.href='/ethic_treaning/retry.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
