<?php /* Smarty version 2.6.31, created on 2026-04-23 13:39:28
         compiled from /srv/alfproduct/smarty/templates/default/mypage/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/mypage/index.tpl', 15, false),)), $this); ?>
...
<div style="float:right;width:730px;border: solid 1px #EDECE0;background-color:#FFFFFF;">
	...
	<div style="float:left;width:680px;margin-left:25px;margin-top:20px;border: solid 1px #EDECE0;border-style: none none solid;">
		<span style="font-size:20px;color:#5E4D34;font-weight: bold;"><?php echo ((is_array($_tmp=$_SESSION['user']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
　様</span>
