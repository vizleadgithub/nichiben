<?php /* Smarty version 2.6.31, created on 2025-12-02 10:34:37
         compiled from /srv/alfproduct/smarty/templates/default/mypage/favorite_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/mypage/favorite_list.tpl', 25, false),array('modifier', 'mb_substr', '/srv/alfproduct/smarty/templates/default/mypage/favorite_list.tpl', 104, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/default/mypage/favorite_list.tpl', 60, false),)), $this); ?>
...
件中）
				...
				<?php $_from = $this->_tpl_vars['arr_list']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['fav'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['fav']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['row']):
        $this->_foreach['fav']['iteration']++;
?>
...
.submit();"><img src="/img/mypage/delete_btn.png" alt="削除" /></a>
							...
							<tr style="font-size:14px;">
								...
								<!--[list_end:<?php echo $this->_tpl_vars['list_end']; ?>
]-->
								<!--[all_count:<?php echo $this->_tpl_vars['all_count']; ?>
]-->
								<td style="text-align:center;font-size:14px;">
									<?php if (! ( $this->_tpl_vars['page'] == 1 && ($this->_foreach['fav']['iteration'] <= 1) ) && ! ( $this->_tpl_vars['page_max'] == 0 && ($this->_foreach['fav']['iteration'] <= 1) )): ?>
...
.submit();" style="color:#5E4D34"><img src="/img/mypage/ic_up.png" alt="上へ" />上へ</a>
								...
								<td style="text-align:center;font-size:14px;">
									<?php if (! ( $this->_tpl_vars['list_end'] == $this->_tpl_vars['all_count'] && ($this->_foreach['fav']['iteration'] == $this->_foreach['fav']['total']) ) && ! ( $this->_tpl_vars['page_max'] == 0 && ($this->_foreach['fav']['iteration'] == $this->_foreach['fav']['total']) )): ?>
