<?php /* Smarty version 2.6.31, created on 2026-03-23 12:56:02
         compiled from /srv/alfproduct/smarty/templates/default/search/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/search/index.tpl', 151, false),array('modifier', 'date_format', '/srv/alfproduct/smarty/templates/default/search/index.tpl', 281, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/default/search/index.tpl', 385, false),array('function', 'html_options', '/srv/alfproduct/smarty/templates/default/search/index.tpl', 179, false),array('function', 'html_checkboxes', '/srv/alfproduct/smarty/templates/default/search/index.tpl', 540, false),)), $this); ?>
<style type="text/css">
	.css_cat_icon{
		float: left;
		text-align: left;
...
?>
						...
						<div style="float:right;text-align:right;display:inline-block;width:180px;">
							<?php if ($this->_tpl_vars['row']['favorite_flg']): ?>
								<form name="favoriteForm" id="favoriteForm<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
" />
									<button type="button" style="border: none; background: none; padding: 0;cursor: pointer;" onclick="favoriteForm<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
()">
										<img src="/img/list/favorite_btn.png">
									</button>
								</form>
								<script type="text/javascript">
								function favoriteForm<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
(){
									let formData = $('#favoriteForm<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['product_id'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
');
									$.ajax({
										type:  "post",
										...
										location.href = "" + "?pcid=<?php echo $this->_tpl_vars['pcid']; ?>
<?php echo $this->_tpl_vars['url_plam']; ?>
&pagemax=<?php echo $this->_tpl_vars['page_max']; ?>
