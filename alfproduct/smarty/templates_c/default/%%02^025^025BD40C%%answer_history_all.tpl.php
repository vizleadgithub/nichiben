<?php /* Smarty version 2.6.31, created on 2025-04-02 21:26:14
         compiled from /srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history_all.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', '/srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history_all.tpl', 20, false),array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history_all.tpl', 31, false),array('modifier', 'string_format', '/srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history_all.tpl', 31, false),)), $this); ?>
...
<?php $this->assign('question', ((is_array($_tmp='question')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['loop_cnt']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['loop_cnt']))); ?>
		...
		<?php if ($this->_tpl_vars['loop_cnt'] == 1): ?>
			<div style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;margin:10px;padding:15px;font-size:18px;font-weight:bold;clear:both;text-align:center;background-color:#F0F8FF;">倫理研修設問</div>
...
】
			...
			<?php echo $this->_tpl_vars['item']['question']; ?>

			<?php if ($this->_tpl_vars['item']['reference'] != ''): ?>
				<p>
				</p>
				<p>
					<?php echo $this->_tpl_vars['item']['reference']; ?>
		...
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:880px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
			<div style="width:100%;">
				...
				<table style="width:100%;text-align:left;">
					<?php $_from = $this->_tpl_vars['item']['branch_info']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
