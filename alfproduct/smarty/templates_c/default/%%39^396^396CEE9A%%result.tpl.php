<?php /* Smarty version 2.6.31, created on 2025-05-09 00:15:52
         compiled from /srv/alfproduct/smarty/templates/default/exam2/result.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/exam2/result.tpl', 66, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/default/exam2/result.tpl', 82, false),)), $this); ?>
<style type="text/css">
...
" <?php if ($this->_tpl_vars['row1']['no'] == $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']]['exam2_answer_contents'][0]): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1']; ?>
.</div>
...
" name="exam2_problem_<?php echo $this->_tpl_vars['row']['exam2_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1']['no']; ?>
" <?php if (isset ( $this->_tpl_vars['exam2_answer'] ) && isset ( $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']] ) && isset ( $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']]['exam2_answer_contents'] ) && array_search ( $this->_tpl_vars['row1']['no'] , $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']]['exam2_answer_contents'] ) !== false): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1']; ?>
.</div>
									<div class="content2"><label for="exam2_problem_<?php echo $this->_tpl_vars['row']['exam2_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
[]" cols="60" rows="10"><?php echo $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']]['exam2_answer_contents'][0]; ?>
</textarea></div>
...
">
			...
			<div style="text-align:center;width:420px;margin-left:246px;">
				...
				<!--<a class="btn1" href="javascript:void(0)" onclick="pop_get_html('/exam2/resubmit_exec.php?e2id=<?php echo $this->_tpl_vars['e2id']; ?>
&pid=<?php echo $this->_tpl_vars['pid']; ?>
');">解答を修正する</a>-->
				<a class="btn1" href="javascript:void(0)" onclick="pop_get_html_sub('/exam2/resubmit_check.php?e2id=<?php echo $this->_tpl_vars['e2id']; ?>
&pid=<?php echo $this->_tpl_vars['pid']; ?>
','exam2Form');">解答を修正する</a>
			</div>
		</div>
