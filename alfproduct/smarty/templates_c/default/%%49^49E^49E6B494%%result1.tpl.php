<?php /* Smarty version 2.6.31, created on 2026-04-02 13:16:42
         compiled from /srv/alfproduct/smarty/templates/default/exam/result1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/exam/result1.tpl', 108, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/default/exam/result1.tpl', 117, false),)), $this); ?>
<style type="text/css">
...
" disabled <?php if (isset ( $this->_tpl_vars['answered_info'] ) && isset ( $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']] ) && isset ( $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_contents'] ) && $this->_tpl_vars['row1']['no'] == $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_contents'][0]): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1']; ?>
.</div>
...
" class="btn_area">
						<a class="btn" href="/exam/resubmit_index1.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
...
<?php endif; ?>"><?php if ($this->_tpl_vars['btn_type'] == '2'): ?>回答修正画面へ<?php else: ?>解答修正画面へ<?php endif; ?></a>
					</div>
				</div>
				<br>
			<?php endforeach; endif; unset($_from); ?>
...
" disabled <?php if (isset ( $this->_tpl_vars['answered_info_q'] ) && isset ( $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']] ) && isset ( $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'] ) && $this->_tpl_vars['row1_q']['no'] == $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'][0]): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1_q']; ?>
.</div>
...
" name="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1_q']['no']; ?>
" disabled <?php if (isset ( $this->_tpl_vars['answered_info_q'] ) && isset ( $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']] ) && isset ( $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'] ) && array_search ( $this->_tpl_vars['row1_q']['no'] , $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'] ) !== false): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1_q']; ?>
.</div>
										<div class="content2"><label for="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1_q']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1_q']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
&eflg=1<?php if ($this->_tpl_vars['qid'] != ''): ?>&qid=<?php echo $this->_tpl_vars['qid']; ?>
<?php endif; ?>"><?php if ($this->_tpl_vars['btn_type_q'] == '2'): ?>回答修正画面へ<?php else: ?>解答修正画面へ<?php endif; ?></a>
					</div>
				</div>
				<br>
			<?php endforeach; endif; unset($_from); ?>
