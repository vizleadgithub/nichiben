<?php /* Smarty version 2.6.31, created on 2025-03-31 10:25:50
         compiled from /srv/alfproduct/smarty/templates/default/product/list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/product/list.tpl', 97, false),array('modifier', 'date_format', '/srv/alfproduct/smarty/templates/default/product/list.tpl', 201, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/default/product/list.tpl', 289, false),array('function', 'html_options', '/srv/alfproduct/smarty/templates/default/product/list.tpl', 120, false),)), $this); ?>
<style type="text/css">
	.css_cat_icon{
		float: left;
		text-align: left;
...
<?php if ($this->_tpl_vars['pcid'] == 'all'): ?>
...
<div style="text-align:right;">
	<a href="/product/list_recommend.php"><img src="/img/list/recommend.png" alt="おすすめ講座" /></a>
</div>

<?php if (! empty ( $this->_tpl_vars['arr_list'] )): ?>
	<div class="pager">
		<div style="text-align:left; width:240px;float:left;">
