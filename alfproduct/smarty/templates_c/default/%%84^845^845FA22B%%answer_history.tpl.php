<?php /* Smarty version 2.6.31, created on 2026-04-14 14:02:18
         compiled from /srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history.tpl', 19, false),array('modifier', 'string_format', '/srv/alfproduct/smarty/templates/default/ethic_treaning/answer_history.tpl', 19, false),)), $this); ?>
...
">
				...
				<div style="text-align:center;padding:20px;">
					<?php if ($this->_tpl_vars['retry_flg']): ?>
						<input type="button" value="設問・解説動画一覧に戻る" onclick="javascript:location.href='/ethic_treaning/retry.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
';">
					<?php else: ?>
