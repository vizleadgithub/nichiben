<?php /* Smarty version 2.6.27, created on 2013-12-26 11:58:34
         compiled from /srv/alfproduct/smarty/templates/smartphone/mypage/buy_detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/mypage/buy_detail.tpl', 28, false),array('modifier', 'number_format', '/srv/alfproduct/smarty/templates/smartphone/mypage/buy_detail.tpl', 92, false),array('function', 'cycle', '/srv/alfproduct/smarty/templates/smartphone/mypage/buy_detail.tpl', 87, false),)), $this); ?>
...
" method="post">
			...
			<table style="width:100%;margin-top:20px;" class="member_table" cellspacing="0" cellpadding="0">
				...
				<?php $_from = $this->_tpl_vars['arr_buy_detail']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
