<?php /* Smarty version 2.6.27, created on 2014-01-27 16:50:10
         compiled from /srv/alfproduct/smarty/templates/smartphone/ethic_treaning/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/ethic_treaning/index.tpl', 31, false),array('modifier', 'string_format', '/srv/alfproduct/smarty/templates/smartphone/ethic_treaning/index.tpl', 31, false),)), $this); ?>
...
<div style="float:right;width:980px;border: solid 1px #EDECE0;background-color:#FFFFFF;">
	...
	<div style="float:left;width:910px;margin-left:25px;margin-top:20px;border: solid 1px #EDECE0;border-style: none none solid;">
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:880px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
			【設問・解説動画一覧】<br />
			設問【01】～設問【10】のテストを受け、解説動画を全て視聴するまで、結果は判定されません。<br />
			全てのテストを受け解説動画を全て視聴した後、「結果判定」ボタンを押して、結果を確認してください。
...
');return false;">
			...
			<div style="padding-top:10px;">
				...
				<?php endif; ?>
				※「結果判定」ボタンが表示されない場合は、ページの更新を行ってください。
			</div>
