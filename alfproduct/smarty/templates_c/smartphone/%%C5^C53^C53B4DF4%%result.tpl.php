<?php /* Smarty version 2.6.27, created on 2020-02-09 13:12:16
         compiled from /srv/alfproduct/smarty/templates/smartphone/exam2/result.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/exam2/result.tpl', 66, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/exam2/result.tpl', 82, false),)), $this); ?>
<style type="text/css">
...
" name="exam2_problem_<?php echo $this->_tpl_vars['row']['exam2_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1']['no']; ?>
" <?php if (array_search ( $this->_tpl_vars['row1']['no'] , $this->_tpl_vars['exam2_answer'][$this->_tpl_vars['row']['exam2_problem_id']]['exam2_answer_contents'] ) !== false): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1']; ?>
.</div>
									<div class="content2"><label for="exam2_problem_<?php echo $this->_tpl_vars['row']['exam2_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
