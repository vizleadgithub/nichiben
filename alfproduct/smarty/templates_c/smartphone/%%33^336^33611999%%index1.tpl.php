<?php /* Smarty version 2.6.31, created on 2025-07-03 19:38:20
         compiled from /srv/alfproduct/smarty/templates/smartphone/exam/index1.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/exam/index1.tpl', 78, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/exam/index1.tpl', 78, false),)), $this); ?>
<style type="text/css">
...
" <?php if ($this->_tpl_vars['row1_q']['no'] == $this->_tpl_vars['answered_info']['exam_answer_contents']): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1_q']; ?>
.</div>
...
" name="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1_q']['no']; ?>
" <?php if (array_search ( $this->_tpl_vars['row1_q']['no'] , $this->_tpl_vars['answered_info']['arr_exam_answer_contents'] ) !== false): ?>checked<?php endif; ?>><?php echo $this->_tpl_vars['row_no1_q']; ?>
.</div>
										<div class="content2"><label for="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1_q']; ?>
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1_q']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
