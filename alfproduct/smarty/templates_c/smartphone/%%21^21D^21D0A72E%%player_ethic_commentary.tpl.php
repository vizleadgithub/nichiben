<?php /* Smarty version 2.6.27, created on 2014-01-09 18:46:38
         compiled from /srv/alfproduct/smarty/templates/smartphone/player/player_ethic_commentary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/player/player_ethic_commentary.tpl', 80, false),)), $this); ?>
<style type="text/css">
ul#player_list{
list-style:none;
width:640px;
...
<?php if ($this->_tpl_vars['back_type'] == 'index'): ?>
	<a href="/ethic_treaning/index.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['pid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">戻る</a>
<?php elseif ($this->_tpl_vars['back_type'] == 'result_history'): ?>
	<a href="/ethic_treaning/result_history.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['pid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">戻る</a>
<?php elseif ($this->_tpl_vars['back_type'] == 'retry'): ?>
	<a href="/ethic_treaning/retry.php?pid=<?php echo ((is_array($_tmp=$this->_tpl_vars['pid'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">戻る</a>
<?php else: ?>
	<a href="/">戻る</a>
<?php endif; ?>
