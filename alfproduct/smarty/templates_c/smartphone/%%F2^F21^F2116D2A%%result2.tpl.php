<?php /* Smarty version 2.6.27, created on 2017-10-15 17:11:24
         compiled from /srv/alfproduct/smarty/templates/smartphone/exam/result2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/exam/result2.tpl', 100, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/exam/result2.tpl', 109, false),)), $this); ?>
<style type="text/css">
			...
			<?php $this->assign('row_no', $this->_foreach['loop']['iteration']); ?>
				<div class="problem">
					<div class="problem_contents_title">
						<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row']['exam_problem_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

						<?php if ($this->_tpl_vars['row']['answer_kind'] == 1 || $this->_tpl_vars['row']['answer_kind'] == 2): ?>
							<div  class="pseigo"><span><?php if ($this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_mark'] == 1): ?>正解<?php else: ?>不正解<?php endif; ?></span></div>
						<?php endif; ?>
						<div class="confbtn"><span><a href="javascript:void(0)" onclick="confirmDisp(<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
);">確認する</a></span></div>
					</div>
					<div id="problem_contents_<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
" class="problem_contents_parent">
...
" disabled <?php if ($this->_tpl_vars['row1']['no'] == $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_contents'][0]): ?>checked<?php endif; ?>><label for="exam_problem_<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1']; ?>
...
" name="exam_problem_<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1']['no']; ?>
" disabled <?php if (array_search ( $this->_tpl_vars['row1']['no'] , $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_contents'] ) !== false): ?>checked<?php endif; ?>><label for="exam_problem_<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1']; ?>
"><?php echo $this->_tpl_vars['row_no1']; ?>
. <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</label></div>
...
[]" cols="115" rows="10" disabled><?php echo $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['arr_exam_answer_contents'][0]; ?>
</textarea></div>
						...
						<?php if ($this->_tpl_vars['row']['answer_kind'] == 1 || $this->_tpl_vars['row']['answer_kind'] == 2): ?>
							<div class="problem_contents problem_result">
								...
								<?php if ($this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_mark'] == 1): ?>
...
」</div>
						...
						<?php if ($this->_tpl_vars['row']['answer_explain_kind'] == 1 && $this->_tpl_vars['answered_info'][$this->_tpl_vars['row']['exam_problem_id']]['exam_answer_mark'] == 1): ?>
					...
					<div id="btn_area_<?php echo $this->_tpl_vars['row']['exam_problem_id']; ?>
" class="btn_area">
						<a class="btn" href="/exam/resubmit_index2.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
&ccno=<?php echo $this->_tpl_vars['ccno']; ?>
&eid=<?php echo $this->_tpl_vars['eid']; ?>
&eno=<?php echo $this->_tpl_vars['row_no']; ?>
&eflg=1<?php if ($this->_tpl_vars['qid'] != ''): ?>&qid=<?php echo $this->_tpl_vars['qid']; ?>
<?php endif; ?>"><?php if ($this->_tpl_vars['btn_type'] == '2'): ?>回答を修正する<?php else: ?>解答を修正する<?php endif; ?></a>
					</div>
				</div>
				<br>
			<?php endforeach; endif; unset($_from); ?>
...
?>
			<?php $this->assign('row_no_q', $this->_foreach['loop_q']['iteration']); ?>
				<div class="problem">
					<div class="problem_contents_title">
						<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row_q']['exam_problem_name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

						<div class="confbtn"><span><a href="javascript:void(0)" onclick="confirmDisp(<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
);">確認する</a></span></div>
					</div>
					<div id="problem_contents_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
" class="problem_contents_parent">
						<div class="problem_contents">
...
" disabled <?php if ($this->_tpl_vars['row1_q']['no'] == $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'][0]): ?>checked<?php endif; ?>><label for="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1_q']; ?>
...
" name="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
[]" value="<?php echo $this->_tpl_vars['row1_q']['no']; ?>
" disabled <?php if (array_search ( $this->_tpl_vars['row1_q']['no'] , $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['exam_answer_contents'] ) !== false): ?>checked<?php endif; ?>><label for="exam_problem_q_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
_<?php echo $this->_tpl_vars['row_no1_q']; ?>
"><?php echo $this->_tpl_vars['row_no1_q']; ?>
. <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['row1_q']['word'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)))) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</label></div>
...
[]" cols="115" rows="10" disabled><?php echo $this->_tpl_vars['answered_info_q'][$this->_tpl_vars['row_q']['exam_problem_id']]['arr_exam_answer_contents'][0]; ?>
</textarea></div>
					...
					<div id="btn_area_<?php echo $this->_tpl_vars['row_q']['exam_problem_id']; ?>
" class="btn_area">
						<a class="btn" href="/exam/resubmit_index2.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
&ccno=<?php echo $this->_tpl_vars['ccno']; ?>
&eid=<?php echo $this->_tpl_vars['eid']; ?>
&eno=<?php echo $this->_tpl_vars['row_no_q']+$this->_tpl_vars['row_no']; ?>
&eflg=1<?php if ($this->_tpl_vars['qid'] != ''): ?>&qid=<?php echo $this->_tpl_vars['qid']; ?>
<?php endif; ?>"><?php if ($this->_tpl_vars['btn_type_q'] == '2'): ?>回答を修正する<?php else: ?>解答を修正する<?php endif; ?></a>
					</div>
				</div>
				<br>
			<?php endforeach; endif; unset($_from); ?>
			...
			<div style="text-align:center;padding:10px;">
				<a class="btn" href="/product/detail.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
">終了する</a>
			</div>
