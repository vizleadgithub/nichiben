<?php /* Smarty version 2.6.31, created on 2025-01-25 11:45:04
         compiled from /srv/alfproduct/smarty/templates/smartphone/inquiry/form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/inquiry/form.tpl', 34, false),)), $this); ?>
<div style="float:right;width:500px;border: none;font-size:15px;margin-bottom:10px;">
...
<div style="float:right;width:500px;border: solid 1px #EDECE0;background-color:#FFFFFF;">
	<div style="float:left;width:480px;height:36px;background-image: url( /img/mypage/h2_back.png );margin-left:10px;margin-top:20px;">
		<span style="font-size:17px;color:#F7982A;font-weight: bold;padding-left: 10px;">お問い合わせ</span>
	</div>

	<div style="float:left;width:450px;margin-left:25px;margin-top:10px;border: solid 1px #EDECE0;border-style: none none solid;">
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:420px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
...
<input type="hidden" name="input_lawyer_number" value="<?php echo ((is_array($_tmp=$_SESSION['user']['lawyer_number'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" /></td>
				</tr>
				<tr>
...
" style="width:260px;" /></td>
			...
			<table style="width:100%;margin-top:20px;" class="member_table" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td style="padding:5px;background-color: #FFFFFF;border:solid 1px #AB9983;padding:5px;text-align:left;font-weight:normal;"><textarea name="input_comment" cols="20" rows="5" style="width:400px;height:260px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['input_comment'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td>
				</tr>
			</table>
