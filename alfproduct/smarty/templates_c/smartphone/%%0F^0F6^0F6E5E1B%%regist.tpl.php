<?php /* Smarty version 2.6.27, created on 2014-01-20 21:18:46
         compiled from /srv/alfproduct/smarty/templates/smartphone/member/regist.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/member/regist.tpl', 14, false),)), $this); ?>
...
?>
					...
					<?php $_from = $this->_tpl_vars['arr_input']['arr_media']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['loop'] = array('total' => count($_from), 'iteration' => 0);
