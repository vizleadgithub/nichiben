<?php /* Smarty version 2.6.27, created on 2017-10-15 17:21:54
         compiled from /srv/alfproduct/smarty/templates/smartphone/exam/index2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/exam/index2.tpl', 101, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/exam/index2.tpl', 101, false),)), $this); ?>
<style type="text/css">
...
function examFormSubmit(flg){
	if(flg=='prev'){
		document.examForm.action = "/exam/index2.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
...
<?php endif; ?>";
		...
		document.examForm.action = "/exam/confirm2.php?pid=<?php echo $this->_tpl_vars['pid']; ?>
&ccno=<?php echo $this->_tpl_vars['ccno']; ?>
&eid=<?php echo $this->_tpl_vars['eid']; ?>
<?php if ($this->_tpl_vars['qid'] != ''): ?>&qid=<?php echo $this->_tpl_vars['qid']; ?>
<?php endif; ?>";
...
">
			...
			<?php if ($this->_tpl_vars['eflg'] == '1'): ?>
				<div style="text-align:center;width:420px;margin-left:246px;">
					...
					<input class="btn1" type="button" onclick="examFormSubmit('confirm');" value="<?php if ($this->_tpl_vars['btn_type'] == '2'): ?>回答を修正する<?php else: ?>解答を修正する<?php endif; ?>">
				</div>
			<?php elseif ($this->_tpl_vars['eno'] == '1'): ?>
				<div style="text-align:center;padding:20px;">
					<input class="btn" type="button" onclick="examFormSubmit('next');" value="次へ">
				</div>
			<?php elseif ($this->_tpl_vars['eno'] == $this->_tpl_vars['eno_max']): ?>
				<div style="text-align:center;width:420px;margin-left:246px;">
					<input class="btn2" type="button" onclick="examFormSubmit('prev');" value="戻る">
					<input class="btn1" type="button" onclick="examFormSubmit('confirm');" value="確認">
				</div>
			<?php else: ?>
				<div style="text-align:center;width:420px;margin-left:246px;">
					<input class="btn2" type="button" onclick="examFormSubmit('prev');" value="戻る">
