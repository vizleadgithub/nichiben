<?php /* Smarty version 2.6.31, created on 2025-01-25 11:14:14
         compiled from /srv/alfproduct/smarty/templates/smartphone/ranking/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/ranking/index.tpl', 67, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/ranking/index.tpl', 224, false),)), $this); ?>
<style type="text/css">
	.css_cat_icon{
		float: left;
		text-align: left;
...
<h1 class="ranking_title" style="display: inline;"><img src="/img/ranking.png" alt="総合ランキング" />総合ランキング</h1>　　　　　<img src="/img/ranking.png" alt="総合ランキング" />その他のランキングは
...
?>
			...
			<?php if ($this->_tpl_vars['row']['file_text'] != ""): ?>
				<a href="/wordpress/wp-content/uploads/<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['file_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" target="_blank">こちら</a>
				<!--<a href="/wordpress/wp-content/uploads/<?php echo ((is_array($_tmp=$this->_tpl_vars['row']['file_path'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['file_text'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</a>-->
			<?php endif; ?>
			<!-- LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL -->
