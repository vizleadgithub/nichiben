<?php /* Smarty version 2.6.27, created on 2019-10-27 20:09:25
         compiled from /srv/alfproduct/smarty/templates/smartphone/settlement/index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/settlement/index.tpl', 37, false),array('modifier', 'number_format', '/srv/alfproduct/smarty/templates/smartphone/settlement/index.tpl', 72, false),)), $this); ?>
		...
		<?php else: ?>
			...
			<div>
				<div style="margin:5px;">
					<input type="radio" name="payment_type" value="1" id="payment_type_1" <?php if ($this->_tpl_vars['ptype'] == 1): ?>checked<?php endif; ?>><label for="payment_type_1">クレジットカード決済(VISA・Master)</label>
					<br />&nbsp;※研修パスポート・eラーニングは本サイトの購入手続き完了後、即時ご利用いただけます。
				</div>
				<div style="margin:5px;">
					<input type="radio" name="payment_type" value="12" id="payment_type_12" <?php if ($this->_tpl_vars['ptype'] == 12): ?>checked<?php endif; ?>><label for="payment_type_12">銀行振り込み</label>
