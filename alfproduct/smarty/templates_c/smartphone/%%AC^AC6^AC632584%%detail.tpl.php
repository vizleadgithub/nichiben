<?php /* Smarty version 2.6.31, created on 2025-05-12 15:37:33
         compiled from /srv/alfproduct/smarty/templates/smartphone/product/detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 137, false),array('modifier', 'count', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 173, false),array('modifier', 'number_format', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 234, false),array('modifier', 'nl2br', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 235, false),array('modifier', 'cat', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 518, false),array('modifier', 'mb_truncate', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 3595, false),array('function', 'html_options', '/srv/alfproduct/smarty/templates/smartphone/product/detail.tpl', 2854, false),)), $this); ?>
...
件）
			...
			<div style="text-align:right;">
				<?php $_from = $this->_tpl_vars['product_list']['icon_img']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['icon_loop'] = array('total' => count($_from), 'iteration' => 0);
...
円(税込)<?php endif; ?></td></tr>-->
					<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:70px;text-align:left;">商品説明</th><td style="padding: 3px 10px;text-align:left;word-break:break-all;"><?php echo ((is_array($_tmp=$this->_tpl_vars['product_list']['memo'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td></tr>
				</table>
			</center>
...
','bookmark','','')" >
													...
													<?php endif; ?>
												<?php endif; ?>
												<?php if ($this->_tpl_vars['product_list'][$this->_tpl_vars['contents_contents_key']] > 0 && $this->_tpl_vars['product_list'][$this->_tpl_vars['contents_contents_so_key']] > 0 && 1 == 2): ?>
													<br>
...
','aux')" >
													...
													<?php endif; ?>
												<?php endif; ?>
												<?php if ($this->_tpl_vars['product_list'][$this->_tpl_vars['contents_baisoku_flg_key']] && 1 == 2): ?>
													<!-- x13 -->
													<br>
													<div style="float:left;width:50px;display:block;height:30px;line-height:30px;font-size:14px;">1.3倍&nbsp;</div>
													<div class="btn_plyer" style="background-image: url(/img/lecture/btn_play_x.png);" ontouchmove="touchMoveFlag=true;" onclick="playerFormSubmit('<?php echo ((is_array($_tmp=$this->_tpl_vars['product_list'][$this->_tpl_vars['contents_contents_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','<?php echo ((is_array($_tmp=$this->_tpl_vars['contents_free_time_key'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','<?php echo ((is_array($_tmp=$this->_tpl_vars['ccno'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','start','','x13')" >
														<div class="btn_plyer_text">始めから再生</div>
...
','aux')" >
													...
													<br>
													<div style="float:left;width:50px;display:block;height:30px;line-height:30px;font-size:14px;">1.3倍&nbsp;</div>
													<div class="btn_plyer" style="background-image: url(/img/lecture/btn_play_so_x.png);" ontouchmove="touchMoveFlag=true;" onclick="playerFormSubmit('<?php echo ((is_array($_tmp=$this->_tpl_vars['product_list'][$this->_tpl_vars['contents_contents_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','<?php echo ((is_array($_tmp=$this->_tpl_vars['contents_free_time_key'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','<?php echo ((is_array($_tmp=$this->_tpl_vars['ccno'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','start','<?php echo ((is_array($_tmp=$this->_tpl_vars['product_list'][$this->_tpl_vars['contents_contents_so_key']])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
','aux13')" >
...
<br /><br />
		...
		<?php if ($this->_tpl_vars['product_list']['contents'] != ''): ?>
			■備考<br />
			<?php echo ((is_array($_tmp=$this->_tpl_vars['product_list']['contents'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
...
～<?php echo ((is_array($_tmp=$this->_tpl_vars['bar_association_branch_info']['receptionist_end_date'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
					...
					<tr style=" border: 2px #FFFFFF solid;">
					<th style="color:#663333;padding: 3px 10px;text-align:left;width:60px;">備考</th><td colspan="3" style="padding: 3px 10px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['bar_association_branch_info']['contents'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td>
					</tr>
					</table>
				</div>
				...
				<?php if ($this->_tpl_vars['disp_web_flg']): ?>
					<?php if ($this->_tpl_vars['bar_association_branch_info']['web_flg'] == '1'): ?>
						...
						<?php elseif ($this->_tpl_vars['limittime_alert_flg']): ?>
...
<div style="width:700px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
	...
	<div style="padding:10px 40px;word-break:break-all;">
		<?php echo ((is_array($_tmp=$this->_tpl_vars['product_list']['memo'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>

		<br />
		<!--
		マニュアルは<a href="/rinri-kenshu-manual.pdf" target=_blank>こちら</a><br />
		よくあるご質問（ＦＡＱ）は<a href="/rinri-kenshu-faq.pdf" target=_blank>こちら</a><br />
		-->
		<a href="/rinri-kenshu-manual.pdf" target=_blank>マニュアルはこちら</a><br />
		<a href="/rinri-kenshu-faq.pdf" target=_blank>ＦＡＱはこちら</a><br />
	</div>
	<div class="detail_title" style="font-size:14px;color:#22730e; text-align:center;">研修資料</div>
...
円(税込)<?php endif; ?></td></tr>-->
		<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:30px;text-align:left;">備考</th><td style="padding: 3px 10px;text-align:left;"><?php echo ((is_array($_tmp=$this->_tpl_vars['product_list']['memo'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</td></tr>
	</table>
	</div>
...
件）</span></p>
	...
	<hr>
	<?php $_from = $this->_tpl_vars['arr_exam2']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
...
<?php if ($this->_tpl_vars['product_list']['product_type_add'] == 1 || $this->_tpl_vars['product_list']['product_type_add'] == 2): ?>
	...
	<?php else: ?>
		<div style="clear:both;">
			...
			<?php $_from = $this->_tpl_vars['arr_related_list']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }$this->_foreach['related_products'] = array('total' => count($_from), 'iteration' => 0);
