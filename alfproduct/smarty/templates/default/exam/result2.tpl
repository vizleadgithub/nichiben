			...
			<!--{assign var=row_no value=$smarty.foreach.loop.iteration}-->
				<div class="problem">
					...
					<div id="btn_area_<!--{$row.exam_problem_id}-->" class="btn_area">
						<a class="btn" href="/exam/resubmit_index2.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}-->&eno=<!--{$row_no}-->&eflg=1<!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->"><!--{if $btn_type=='2'}-->回答修正画面へ<!--{else}-->解答修正画面へ<!--{/if}--></a>
					</div>
				</div>
				<br>
			<!--{/foreach}-->
			...
			<!--{assign var=row_no_q value=$smarty.foreach.loop_q.iteration}-->
				<div class="problem">
					...
					<div id="btn_area_<!--{$row_q.exam_problem_id}-->" class="btn_area">
						<a class="btn" href="/exam/resubmit_index2.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}-->&eno=<!--{$row_no_q+$row_no}-->&eflg=1<!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->"><!--{if $btn_type_q=='2'}-->回答修正画面へ<!--{else}-->解答修正画面へ<!--{/if}--></a>
					</div>
				</div>
				<br>
			<!--{/foreach}-->
