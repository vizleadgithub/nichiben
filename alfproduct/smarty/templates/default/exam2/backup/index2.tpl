...
function examFormSubmit(flg){
	if(flg=='prev'){
		document.examForm.action = "/exam/index2.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}-->&eno=<!--{$eno-1}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	} else if(flg=='next'){
		document.examForm.action = "/exam/index2.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}-->&eno=<!--{$eno+1}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	} else if(flg=='confirm'){
		document.examForm.action = "/exam/confirm2.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	} else {
		...
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:880px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
				...
				<div class="problem">
					...
					<div class="problem_contents">
						...
						<!--{if $row.answer_kind==1}-->
							...
							<!--{assign var=row_no1 value=$smarty.foreach.loop1.iteration}-->
								<div class="problem_content">
									<div class="content1"><input type="radio" id="exam_problem_<!--{$row.exam_problem_id}-->_<!--{$row_no1}-->" name="exam_problem_<!--{$row.exam_problem_id}-->[]" value="<!--{$row1.no}-->" <!--{if $row1.no==$answered_info.exam_answer_contents}-->checked<!--{/if}-->><!--{$row_no1}-->.</div>
						...
						<!--{elseif $row.answer_kind==2}-->
							...
							<!--{assign var=row_no1 value=$smarty.foreach.loop1.iteration}-->
								<div class="problem_content">
									<div class="content1"><input type="checkbox" id="exam_problem_<!--{$row.exam_problem_id}-->_<!--{$row_no1}-->" name="exam_problem_<!--{$row.exam_problem_id}-->[]" value="<!--{$row1.no}-->" <!--{if array_search($row1.no, $answered_info.arr_exam_answer_contents)!==false}-->checked<!--{/if}-->><!--{$row_no1}-->.</div>
									<div class="content2"><label for="exam_problem_<!--{$row.exam_problem_id}-->_<!--{$row_no1}-->"><!--{$row1.word|escape|nl2br}--></label></div>
								</div>
								<br style="clear:both;">
							<!--{/foreach}-->
						...
						<div class="problem_contents">
							...
							<!--{if $row_q.answer_kind==1}-->
								...
								<!--{assign var=row_no1_q value=$smarty.foreach.loop1_q.iteration}-->
									<div class="problem_content">
										<div class="content1"><input type="radio" id="exam_problem_q_<!--{$row_q.exam_problem_id}-->_<!--{$row_no1_q}-->" name="exam_problem_q_<!--{$row_q.exam_problem_id}-->[]" value="<!--{$row1_q.no}-->" <!--{if $row1_q.no==$answered_info.exam_answer_contents}-->checked<!--{/if}-->><!--{$row_no1_q}-->.</div>
							...
							<!--{elseif $row_q.answer_kind==2}-->
								...
								<!--{assign var=row_no1_q value=$smarty.foreach.loop1_q.iteration}-->
									<div class="problem_content">
										<div class="content1"><input type="checkbox" id="exam_problem_q_<!--{$row_q.exam_problem_id}-->_<!--{$row_no1_q}-->" name="exam_problem_q_<!--{$row_q.exam_problem_id}-->[]" value="<!--{$row1_q.no}-->" <!--{if array_search($row1_q.no, $answered_info.arr_exam_answer_contents)!==false}-->checked<!--{/if}-->><!--{$row_no1_q}-->.</div>
										<div class="content2"><label for="exam_problem_q_<!--{$row_q.exam_problem_id}-->_<!--{$row_no1_q}-->"><!--{$row1_q.word|escape|nl2br}--></label></div>
									</div>
									<br style="clear:both;">
								<!--{/foreach}-->
			...
			<!--{if $eflg=='1'}-->
				<div style="text-align:center;width:420px;margin-left:246px;">
					<input class="btn2" type="button" onclick="examFormSubmit('confirm');" value="戻る">
					<input class="btn1" type="button" onclick="examFormSubmit('confirm');" value="<!--{if $btn_type=='2'}-->回答を修正する<!--{else}-->解答を修正する<!--{/if}-->">
				</div>
			<!--{elseif $eno_max=='1'}-->
				<div style="text-align:center;padding:20px;">
					<input class="btn" type="button" onclick="examFormSubmit('confirm');" value="次へ">
				</div>
			<!--{elseif $eno=='1'}-->
				<div style="text-align:center;padding:20px;">
					<input class="btn" type="button" onclick="examFormSubmit('next');" value="次へ">
				</div>
			<!--{elseif $eno==$eno_max}-->
				<div style="text-align:center;width:420px;margin-left:246px;">
					<input class="btn2" type="button" onclick="examFormSubmit('prev');" value="戻る">
					<input class="btn1" type="button" onclick="examFormSubmit('confirm');" value="次へ">
				</div>
			<!--{else}-->
				<div style="text-align:center;width:420px;margin-left:246px;">
					<input class="btn2" type="button" onclick="examFormSubmit('prev');" value="戻る">
					<input class="btn1" type="button" onclick="examFormSubmit('next');" value="次へ">
				</div>
			<!--{/if}-->
			</div>
