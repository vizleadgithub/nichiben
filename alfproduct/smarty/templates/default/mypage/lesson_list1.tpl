		...
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:650px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
			...
			<table style="width:100%;" class="member_table" cellspacing="0" cellpadding="0">
				...
				<tr style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->">
					...
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">開始日<br /><!--{$val.TSUB_regist_at|escape}--></td>
					...
					<td rowspan="2" style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><!--{if $val.koukai_flg}--><a href="/product/detail.php?pid=<!--{$val.product_id|escape}-->" style="color:#796A57;">講座詳細へ<!--{else}-->公開終了<!--{/if}--></a></td>
					<td rowspan="2" style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><a href="/mypage/lesson_list1_print.php?pid=<!--{$val.product_id|escape}-->" style="color:#796A57;">印刷</a></td>
				</tr>
				<tr style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->">
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">受講率<br /><!--{if $val.all_complete_flg}-->完了<!--{else}--><!--{$val.max_percent|escape}-->%<!--{/if}--></td>
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;">終了日<br /><!--{if $val.all_complete_flg}--><!--{$val.TSUB_complete_date|escape}--><!--{else}-->-<!--{/if}--></td>
