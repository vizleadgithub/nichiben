		...
		<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:650px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
			...
			<table style="width:100%;" class="member_table" cellspacing="0" cellpadding="0">
				...
				<tr style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->">
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><!--{if $val.participation_flg==1}-->済<!--{else}-->未<!--{/if}--></td>
					...
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:left;vertical-align:middle;"><!--{$val.dates|escape}--></td>
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:left;vertical-align:middle;"><!--{$val.disp_sponsor}--></td>
					<td style="<!--{if $cycle_bg=="1"}-->background-color: #F5F5F5;<!--{else}-->background-color: #FFFFFF;<!--{/if}-->border:solid 1px #AB9983;padding:5px;text-align:center;vertical-align:middle;"><!--{if $val.koukai_flg}--><a href="/product/detail.php?pid=<!--{$val.product_id|escape}-->" style="color:#796A57;">講座詳細へ</a><!--{else}-->受付終了<!--{/if}--></td>
				</tr>
				<!--{/foreach}-->
			</table>
