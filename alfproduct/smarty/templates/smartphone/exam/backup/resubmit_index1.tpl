...
function examFormSubmit(flg){
	if(flg=='prev'){
		document.examForm.action = "/exam/result1.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	} else if(flg=='exec'){
		document.examForm.action = "/exam/resubmit_exec1.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}-->&eno=<!--{$eno}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	} else {
		document.examForm.action = "/exam/result1.php?pid=<!--{$pid}-->&ccno=<!--{$ccno}-->&eid=<!--{$eid}--><!--{if $qid!=''}-->&qid=<!--{$qid}--><!--{/if}-->";
	}
