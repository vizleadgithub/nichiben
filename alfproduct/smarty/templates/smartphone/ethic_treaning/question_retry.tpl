			...
			<div style="float:left;font-size:16px;line-height: 22px;color:#525252;width:880px;margin-left:15px;margin-top:20px;border: none;margin-bottom:20px;">
				<form action="/ethic_treaning/question_answer_retry.php?pid=<!--{$pid}-->&qid=<!--{$qid}-->" method="post" name="form_answer">
					...
					<ul style="text-align:center;padding:20px;list-style:none;padding-left:280px;">
						<li style="float:left;padding:0 20px;"><a href="javascript:void(0);" onclick="javascript:location.href='/ethic_treaning/retry.php?pid=<!--{$pid}-->';"><img src="/img/button/question1_btn.png" alt="今は回答しない" /></a></li>
