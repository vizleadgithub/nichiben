<script type="text/javascript">
	...
	function playerEthicOpenWindowSubmit(vid,ftn,ccno,view_btn,vid2,codec){
		...
		document.playerForm.method = "post";
		<!--{if !$is_sp}-->
			document.playerForm.action = "/player/player_ethic_tkp.php?term=pc";
		<!--{else}-->
			document.playerForm.action = "/player/player_ethic_tkp.php?term=sp";
		<!--{/if}-->
		document.playerForm.submit();
	}
...
<div style="width:700px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
	...
	<div style="padding:10px 40px;word-break:break-all;">
		...
		<br />
		<a href="/rinri-kenshu-manual.pdf">マニュアルはこちら</a><br />
		<a href="/rinri-kenshu-faq.pdf">ＦＡＱはこちら</a><br />
	</div>
<!--{*
	<table style="background-color:#F5F8EF;width:680px;">
	<!--{if $product_list.teacher != ''}-->
...
<div style="clear:both;">
	...
	<!--{foreach name=recommend_products from=$arr_recommend_list item=recommend_products}-->
		...
		<a href="/product/detail_tkp.php?pid=<!--{$recommend_products.product_id|escape}-->" alt="<!--{$recommend_products.product_name|escape}-->" title="<!--{$recommend_products.product_name|escape}-->"><img src="/resize_image.php?image=<!--{$recommend_products.thumbnail|escape}-->&width=90&height=90" alt="" /></a><br />
		<a href="/product/detail_tkp.php?pid=<!--{$recommend_products.product_id|escape}-->" alt="<!--{$recommend_products.product_name|escape}-->" title="<!--{$recommend_products.product_name|escape}-->"><!--{$recommend_products.product_name|mb_truncate:14:"..."|escape}--></a><br />
	...
	<!--{else}-->
		<div style="clear:both;">
			...
			<!--{foreach name=related_products from=$arr_related_list item=related_products}-->
				<a href="/product/detail_tkp.php?pid=<!--{$related_products.pid|escape}-->" alt="<!--{$related_products.name|escape}-->" title="<!--{$related_products.name|escape}-->"><!--{$related_products.name|escape}--></a><br>
				<!--
				...
				<!--{if $related_products.thumbnail != ''}-->
					<a href="/product/detail_tkp.php?pid=<!--{$related_products.pid|escape}-->" alt="<!--{$related_products.name|escape}-->" title="<!--{$related_products.name|escape}-->"><img src="/resize_image.php?image=<!--{$related_products.thumbnail|escape}-->&width=90&height=90" alt="" /></a><br />
				<!--{else}-->
					<a href="/product/detail_tkp.php?pid=<!--{$related_products.pid|escape}-->" alt="<!--{$related_products.name|escape}-->" title="<!--{$related_products.name|escape}-->"><img src="/resize_image.php?image=noimage.jpg&width=90&height=90" alt="" /></a><br />
				<!--{/if}-->
				<a href="/product/detail_tkp.php?pid=<!--{$related_products.pid|escape}-->" alt="<!--{$related_products.name|escape}-->" title="<!--{$related_products.name|escape}-->"><!--{$related_products.name|mb_truncate:14:"..."|escape}--></a><br />
				<!--
