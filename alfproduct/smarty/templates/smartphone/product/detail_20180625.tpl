...
<input type="button" value="　関連講座　" onClick="window.location.href='#RelatedCourseBlock';" style="float:right;" />
<!--{/if}-->
...
<!--{if $product_list.product_type_add == 1}-->
	<!--{* ------------------------------------未購入orパスポート無------------------------------------ *}-->
	<!--{if $buy_flg}-->
<div style="width:468px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
			...
			<div id="rollover">
				...
				<div style="width:155px;">
					...
					|| ($product_list.contents_contents10!='' && $product_list.contents_view_flg10)
						...
						<!--{assign var=comment_flg value="false"}-->
						
						<!--{if $product_list.$contents_contents_key!='' && $product_list.$contents_view_flg_key}-->
							<!--{assign var=comment_flg value="true"}-->
							...
							<!--{/if}-->
								...
								<!--{if $product_list.$contents_thumbnail_key != ''}-->
									<img src="/resize_image.php?image=<!--{$product_list.$contents_thumbnail_key|escape}-->&width=150&height=150" alt="" onclick="playerFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','start')" style="cursor:pointer;" />
								<!--{elseif $product_list.$video_thumbnail_key != ''}-->
									<img src="/resize_video_image.php?image=<!--{$product_list.$video_thumbnail_key|escape}-->&width=150&height=150" alt="" onclick="playerFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','start')" style="cursor:pointer;" />
								<!--{else}-->
									<img src="/resize_image.php?image=noimage.jpg&width=150&height=150" alt="" onclick="playerFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','start')" style="cursor:pointer;" />
								<!--{/if}-->
...
<table style="background-color:#F5F8EF;float:right;width:285px;">
			<!--{if $product_list.teacher != ''}-->
			<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:70px;text-align:left;" nowrap>講師名</th><td style="padding: 3px 10px;text-align:left;"><!--{$product_list.teacher|escape}--></td></tr>
			<!--{/if}-->
...
<div style="width:468px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
		...
		<center>
		<table style="background-color:#F5F8EF;width:430px;">
		<!--{if $product_list.teacher != ''}-->
		<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:70px;text-align:left;" nowrap>講師名</th><td style="padding: 3px 10px;text-align:left;"><!--{$product_list.teacher|escape}--></td></tr>
		<!--{/if}-->
		<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:70px;text-align:left;">掲載期間</th><td style="padding: 3px 10px;text-align:left;">
...
※テストを全て受けないと，受講完了にはなりません。<br>
		...
		<div style="text-align:center;padding:20px 0;">
			<input type="image" src="/img/lecture/dl_btn.png" onClick="downloadPopup();">
		</div>
					...
					<!--{if $product_list.product_kind_flg==3}-->
						...
						<!--{if $product_list.$contents_contents_key!='' && $product_list.$contents_view_flg_key}-->
							 <!--{if $ccno==1}-->
								...
								<center style="float:left;width:60%;">
								<div class="detail_btn">
									<img src="/img/lecture/play_btn_off.png" alt="初めから再生" onclick="playerFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','start')" style="cursor:pointer;" />
									<!--{if $product_list.$video_view_flg_key && !$product_list.$video_complete_flg_key}-->
										<img src="/img/lecture/resume_btn_off.png" alt="続きから再生" onclick="playerFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','bookmark')" style="cursor:pointer;" />
									<!--{else}-->
								...
								<div class="detail_btn">
									...
									<!--{if $product_list.$exam_id_test_key_prev>0 || $product_list.$exam_id_question_key_prev>0}-->
										...
										<!--{if ($product_list.$exam_test_all_answered_key_prev && $product_list.$exam_test_passing_flg_key_prev=='1') || ($product_list.$exam_question_all_answered_key_prev && $product_list.$exam_question_passing_flg_key_prev=='1')}-->
											...
											<!--{/if}-->
										<!--{else}-->
											<img src="/img/lecture/play_btn_none.png" alt="初めから再生" style="cursor:pointer;" />
											<img src="/img/lecture/resume_btn_none.png" alt="続きから再生" style="cursor:pointer;" />
										<!--{/if}-->
									<!--{else}-->
										<!--{* すべてのテストに合格している場合は表示 *}-->
...
<div style="width:468px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
	<div>
		...
		<table style="background-color:#F5F8EF;width:430px;margin:20px;">
			...
			<tr style=" border: 2px #FFFFFF solid;"><th style="color:#663333;padding: 3px 10px;text-align:left;width:70px;text-align:left;">単品価格</th><td style="padding: 3px 10px;text-align:left;"><!--{if $product_list.price_intax==0}-->無料<!--{else}--><!--{$product_list.price_intax|escape|number_format}-->円(税込)<!--{/if}--></td></tr>
...
<div style="width:468px;float:left;clear:both;background-color:#fcfcfc;border-left:solid 1px #f3f3f3;border-right:solid 1px #f3f3f3;padding:5px 15px;">
	...
	<div style="padding:30px 15px;text-align:center;font-size:20px;color:#000000;font-weight:bold;">
		...
		「テスト・解説：<!--{if !$ethic_status}-->未受講<!--{elseif $ethic_status === '2' || $ethic_status === '5' || $ethic_status === '6' || $ethic_status === '7' || $ethic_status === '8'}-->受講済<!--{else}-->受講中<!--{/if}-->」
	</div>
...
*}-->
	...
	<div style="text-align:center;padding:20px 0;">
		<input type="image" src="/img/lecture/dl_btn.png" onClick="downloadPopup();">
		<!--<input type="button" value="資料一覧からダウンロード" onClick="downloadPopup();" />-->
	</div>
	...
	<div>
		...
		|| ($product_list.contents_contents10!='')
			...
			<!--{if $product_list.$contents_contents_key!=''}-->
				...
				<div class="detail_btn"><center>
					<!--{if !$is_sp}-->
						<img src="/img/lecture/play_btn_off.png" alt="初めから再生" onclick="playerEthicFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','start')" style="cursor:pointer;" />
						<!--{if $product_list.$video_view_flg_key && !$product_list.$video_complete_flg_key}-->
							<img src="/img/lecture/resume_btn_off.png" alt="続きから再生" onclick="playerEthicFormSubmit('<!--{$product_list.$contents_contents_key|escape}-->','<!--{$contents_free_time_key|escape}-->','<!--{$ccno|escape}-->','bookmark')" style="cursor:pointer;" /></center>
						<!--{else}-->
							<img src="/img/lecture/resume_btn_none.png" alt="続きから再生" style="cursor:pointer;" />
						<!--{/if}-->
					<!--{else}-->
...
<br />
	...
	<!--{if $all_view_flg}-->
		...
		<table style="background-color:#F5F8EF;width:300px;">
			...
			<!--{if !$ethic_status}-->
				未受講
				<br /><a href="/ethic_treaning?pid=<!--{$pid|escape}-->"><img src="/img/button/test_btn.png" alt="テストを受ける" /></a>
...
<script type="text/javascript">
<!--{* 動画の読み込みを遅延させるスクリプト(プレイヤー側が同時読み込みに非対応のため) *}-->
<!--{*
<!--{if !empty($arr_player_iframe)}-->
	var loop = 0;
	var iframe_html = new Array();
	<!--{foreach name=player_iframe_js from=$arr_player_iframe.frame item=player_iframe}-->
	iframe_html[<!--{$smarty.foreach.player_iframe_js.index}-->] = '<!--{$player_iframe}-->';
	<!--{/foreach}-->

	function printIFrame(){
		if (jsIsset(iframe_html[loop])){
			document.getElementById('iframe' + loop).innerHTML = iframe_html[loop];
			if(loop < <!--{$player_iframe_count}-->){
				loop += 1;
				setTimeout("printIFrame()",2000);
			}
		}
	}
	function jsIsset( data ){
	    return ( typeof( data ) != 'undefined' );
	}
	window.onLoad=printIFrame();
<!--{/if}-->
*}-->

<!--{*
function playerFormSubmit(vid,ftn,ccno,view_btn){
    window.open("about:blank","playerDisp","width=675,height=660,menubar=no,toolbar=no,scrollbars=yes,resizable=yes");
    
    <!--{if !empty($arr_player_iframe)}-->
    <!--{foreach name=player_iframe_frame_no from=$arr_player_iframe.frame_no item=player_iframe_frame_no}-->
    document.getElementById('playerFrame<!--{$player_iframe_frame_no}-->').contentWindow.ak_pause();
    <!--{/foreach}-->
    <!--{/if}-->
...
function playerFormSubmit(vid,ftn,ccno,view_btn){
    ...
    setTimeout(function(){
        w.onLoad = playerOpenWindowSubmit(vid,ftn,ccno,view_btn);
    }, 1000);
}
function playerOpenWindowSubmit(vid,ftn,ccno,view_btn){
    document.getElementById("hid_vid").value = vid;
    document.getElementById("hid_ftn").value = ftn;
    document.getElementById("hid_ccno").value = ccno;
    document.getElementById("hid_view_btn").value = view_btn;
...
function playerEthicFormSubmit(vid,ftn,ccno,view_btn){
    var w = window.open("about:blank","playerDisp","width=675,height=660,menubar=no,toolbar=no,scrollbars=yes,resizable=yes");
    setTimeout(function(){
        w.onLoad = playerEthicOpenWindowSubmit(vid,ftn,ccno,view_btn);
    }, 1000);
}
function playerEthicOpenWindowSubmit(vid,ftn,ccno,view_btn){
    document.getElementById("hid_vid").value = vid;
    document.getElementById("hid_ftn").value = ftn;
    document.getElementById("hid_ccno").value = ccno;
    document.getElementById("hid_view_btn").value = view_btn;
...
<!--{*
<!--{if !empty($arr_player_iframe)}-->
$(window).unload(printIFrame());
window.onunload = function(){printIFrame();}
<!--{/if}-->
*}-->
</script>
...
window.onload =function(){
    ...
    var regrep = "&width=40&height=40";
    var newimg = new Array();
    for (var i = 0; i <myImg.length; i++) {
        newimg[i] = new Image();
        newimg[i].src = myImg[i].src;
        myImg[i].onmouseover =function() {
            var href = this.src.replace(regrep,"&width=180&height=100");
