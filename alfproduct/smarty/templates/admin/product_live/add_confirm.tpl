...
<!--{foreach from=$arr_input item=item key=key}-->
	<!--{if $key=="bar_association_sponsor"}-->
	<!--{elseif $key=="bar_association_sponsor_unselect"}-->
	<!--{elseif $key=="bar_association_target"}-->
...
<!--{foreach from=$arr_input.arr_term_id key=key item=item}-->
<input type="hidden" name="arr_term_id[]" value="<!--{$key|escape}-->" />
<!--{/foreach}-->
