...
<!-- style="background: none repeat scroll 0% 0% rgb(246, 246, 243);"-->
		...
		<tr>
			<th>研修実施日</th>
			<td colapan="3">
				<input type="text" name="search_dates_start" id="start_date" value="<!--{$search_dates_start|escape}-->" readonly="" /> 
				<a class="clear_date" href="javascript:void(0);" onclick="javascript:document.search_form.start_date.value='';">クリア</a>
				～
				<input type="text" name="search_dates_end" id="end_date" value="<!--{$search_dates_end|escape}-->" readonly="" /> 
...
*}-->
		...
		<tr>
			<th>主催弁護士会</th>
			<td colspan = "3">
				<!--{html_options name=search_bar_association options=$mtb_bar_association selected=$search_bar_association}-->
			</td>
		</tr>
		<!--{/if}-->
	</table>
...
<table class="list">
	...
	<tr style="">
		...
		<td class="tdc" style="<!--{if $cycle_bg=="1"}-->background: none repeat scroll 0% 0% rgb(246, 246, 243);<!--{/if}-->"><!--{$mtb_bar_association[$row.bar_association_id]}--></td>
