...
*}-->
		<tr>
			<td style="" colspan="2">
				...
				<!--{else}-->
					対象となる会員は　<!--{$member_count|escape}-->　人でした。<a href="javascript:void(0);" onclick="javascript:document.csv_sended_user.submit();"><img alt="CSVダウンロード" src="/alfproduct/images/abtn_csv.png"></a><br>
				<!--{/if}-->
			</td>
		</tr>
		<!--{if $submit_status=="0"}-->
		...
		<!--{else}-->
			<form action="csv_sended_user.php" accept-charset="utf-8" method="post" name="csv_sended_user" target="_blank">
