		...
		<tr>
			...
			<td>
				<!--{foreach from=$arr_passport_target key="passport_target_id" item="passport_target_name"}-->
					<input type="checkbox" name="search_passport_target[]" value="<!--{$passport_target_id}-->" id="search_passport_target_<!--{$passport_target_id}-->"<!--{if in_array($passport_target_id,$search_passport_target)}--> checked="checked"<!--{/if}-->><label for="search_passport_target_<!--{$passport_target_id}-->"><!--{$passport_target_name}--></label>&nbsp;
				<!--{/foreach}-->
			</td>
		</tr>
		<tr>
