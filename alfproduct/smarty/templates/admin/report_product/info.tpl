...
<a href="csv.php?pid=<!--{$pid|escape}-->&data=<!--{$post_data|escape|urlencode}-->&aid=<!--{$aid|escape}-->" target="_blank" rel="noopener noreferrer"><img src="/alfproduct/images/abtn_csv.png" alt="CSVダウンロード"></a>
