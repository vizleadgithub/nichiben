...
$_SESSION['wp_page_head_title'] = '講座一覧';
...
foreach ($ret as $key => $val){
	...
	$ret_etcmovie = $objDbConnect->query_fetch_arr($sql);
	foreach ($ret_etcmovie as $key_etcmovie => $val_etcmovie){
		if ( false !== strpos( ",".$arr_list[$key]["term_id"].",", ",".$val_etcmovie["term_id"]."," ) ) {
...
$template->layout('product/list.tpl');
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$objDbConnect->close();
exit();
?>