...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$pagemax = 5;
if( isset($_SESSION["productlistlimit.pagemax"]) && !empty($_SESSION["productlistlimit.pagemax"]) ){
	$pagemax = $_SESSION["productlistlimit.pagemax"];
}
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
	$_SESSION["productlistlimit.page"] = 1;
	$_SESSION["productlistlimit.sort"] = 1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$page = 1;
if( isset($_SESSION["productlistlimit.page"]) && !empty($_SESSION["productlistlimit.page"]) ){
	$page = $_SESSION["productlistlimit.page"];
}
if( isset($_GET["page"]) && !empty($_GET["page"]) && is_numeric($_GET["page"]) ){
	$page = $_GET["page"];
	$_SESSION["productlistlimit.page"] = $page;
}
if( isset($_GET["pagemax"]) && is_numeric($_GET["pagemax"]) ){
	$pagemax = $_GET["pagemax"];
	$_SESSION["productlistlimit.pagemax"] = $pagemax;
}
$objPager->setNowPage( $page );
$objPager->setPageMax( $pagemax );
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$sort = 1;
if( isset($_SESSION["productlistlimit.sort"]) && !empty($_SESSION["productlistlimit.sort"]) ){
	$sort = $_SESSION["productlistlimit.sort"];
}
if( isset($_GET["sort"]) && !empty($_GET["sort"]) && is_numeric($_GET["sort"]) ){
	$sort = $_GET["sort"];
	$_SESSION["productlistlimit.sort"] = $sort;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$where = " WHERE tbl_product.del_flg='0'";
$where.= " AND ( tbl_product_add.product_type_add = 1 )";
$where.= " AND ( (tbl_product_live_training.ethic_flg = 0 OR tbl_product_live_training.ethic_flg IS NULL) )";
...
$template->layout('product/list_limit.tpl');
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$objDbConnect->close();
exit();
?>