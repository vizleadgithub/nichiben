...
if( $_SERVER["REQUEST_METHOD"] == "POST" ){
	...
	$_SESSION["productlistbarassociationliveother.sort"] = 1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$page = 1;
if( isset($_SESSION["productlistbarassociationliveother.page"]) && !empty($_SESSION["productlistbarassociationliveother.page"]) ){
	$page = $_SESSION["productlistbarassociationliveother.page"];
}
if( isset($_GET["page"]) && !empty($_GET["page"]) && is_numeric($_GET["page"]) ){
	$page = $_GET["page"];
	$_SESSION["productlistbarassociationliveother.page"] = $page;
}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$sort = 1;
if( isset($_SESSION["productlistbarassociationliveother.sort"]) && !empty($_SESSION["productlistbarassociationliveother.sort"]) ){
	$sort = $_SESSION["productlistbarassociationliveother.sort"];
}
if( isset($_GET["sort"]) && !empty($_GET["sort"]) && is_numeric($_GET["sort"]) ){
	$sort = $_GET["sort"];
	$_SESSION["productlistbarassociationliveother.sort"] = $sort;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$where = " WHERE 1=1 ";
