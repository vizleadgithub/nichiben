...
(function($) {
    ...
    window.$pop.prototype = {
        ...
        getTextContent: function( c, cls ) {
            var d = $( '<div class="pop1"></div>' ).html( '<p class="pwAlertContent">' + c + '</p>' );
            switch( cls ) {
                case 'warning':
                    d.addClass( 'warning' );
                    break;
        ...
        dragStart: function( evt ) {
            ...
            if( ifr.item( 0 ) ) {
                ...
                var cvDiv = $( '<div class="pop2">&nbsp;</div>' ).css( { 'position': 'absolute', 'top': ot + 'px', 'left': 0, 'width': '100%', 'height': cvh + 'px' } );
        ...
        dragResize: function( evt ) {
            ...
            if( ifr.item( 0 ) ) {
                ...
                var cvDiv = $( '<div class="pop3">&nbsp;</div>' ).css( { 'position': 'absolute', 'top': ot + 'px', 'left': 0, 'width': '100%', 'height': cvh + 'px' } );
                $( '#pwbody' + this.pwIDNumber ).append( cvDiv );
            }
