...
if( $err_flg==0 ){
	...
	//$objDbConnect->execute($sql);
	$sql = "update tbl_order set payment_status='2', claim_flg='0', web_flg='1', price='0', tax='0', payment_date='$payment_date', order_date='$payment_date' where order_id='".$order_id."' ";
	$objDbConnect->execute($sql);
	
	// 注文詳細の支払フラグ更新・カート情報削除
	$sql = "update tbl_order_detail set payment_status='2', price='0', sell_price='0', pay_total='0', payment_date='$payment_date' where order_id='".$order_id."' ";
	$objDbConnect->execute($sql);
	unset($_SESSION["cart"]);
	...
	//+++++++++++++++++++++++++++++++++++++++++++++++++++
	$str_mail = file_get_contents( dirname(__FILE__) ."./../../module/order4.mail" );
