					...
					if($list_count < 8){
						...
						<li style="min-height: 36px;max-height: 48px;overflow:hidden;">
							<div>
								...
								<a style="display:inline-block;text-decoration:none;color:#3b2707;font-weight:bold;float:left;width:630px;overflow: hidden;max-height: 36px;" class="textOverflowTest4" href="/product/detail.php?pid=<?php echo (int)$val['product_id']; ?>">
