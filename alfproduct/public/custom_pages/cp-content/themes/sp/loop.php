				...
				<div class="entry-summary" style="padding:5px 20px 10px 20px;">
					...
					<div style="text-align:right;">
						<?php if (!$disp_flg){ ?>
							受講対象でない会場研修です。
						<?php } else { ?>
							<a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark" style="color: #796A57;">>>詳細へ</a>
						<?php } ?>
					</div>
				</div><!-- .entry-summary -->
			<?php else : ?>
