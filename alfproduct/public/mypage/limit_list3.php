...
$_SESSION['wp_page_head_title'] = '掲載終了間近の講座(お気に入り)';
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$pagemax = 5;
if( isset($_SESSION["mypage.limit_list3.pagemax"]) && !empty($_SESSION["mypage.limit_list3.pagemax"]) ){
	$pagemax = $_SESSION["mypage.limit_list3.pagemax"];
}

if( $_SERVER["REQUEST_METHOD"] == "POST" ){
	$_SESSION["limit_list3.page"] = 1;
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$page = 1;
if( isset($_SESSION["limit_list3.page"]) && !empty($_SESSION["limit_list3.page"]) ){
	$page = $_SESSION["limit_list3.page"];
}
if( isset($_GET["page"]) && !empty($_GET["page"]) && is_numeric($_GET["page"]) ){
	$page = $_GET["page"];
	$_SESSION["limit_list3.page"] = $page;
}
if( isset($_GET["pagemax"]) && is_numeric($_GET["pagemax"]) ){
	$pagemax = $_GET["pagemax"];
	$_SESSION["mypage.limit_list3.pagemax"] = $pagemax;
}
...
$search_buy_date = '';
/*
if( isset($_SESSION["limit_list3.search_buy_date"]) && !empty($_SESSION["limit_list3.search_buy_date"]) ){
	$search_buy_date = $_SESSION["limit_list3.search_buy_date"];
}
if( isset($_GET["search_buy_date"]) && !empty($_GET["search_buy_date"]) ){
	$search_buy_date = $_GET["search_buy_date"];
	$_SESSION["limit_list3.search_buy_date"] = $search_buy_date;
}
if( isset($_GET["search_buy_date"]) && empty($_GET["search_buy_date"]) ){
	$search_buy_date = "";
	$_SESSION["limit_list3.search_buy_date"] = "";
}
*/
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
$template->layout_noside('mypage/limit_list3.tpl');
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
